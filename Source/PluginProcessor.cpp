...
juce::AudioProcessorValueTreeState::ParameterLayout HDrumsAudioProcessor::createParameterLayout()
{
    ...
    juce::StringArray processorMidiNotes = juce::StringArray("C-2", "C#-2", "D-2", "D#-2", "E-2", "F-2", "F#-2", "G-2", "G#-2", "A-2", "A#-2", "B-2",
    ...
    auto kickNoteParam = std::make_unique<juce::AudioParameterChoice>(KICK_MIDI_NOTE_ID, KICK_MIDI_NOTE_NAME, processorMidiNotes, 59 + 12);
    auto snareNoteParam = std::make_unique<juce::AudioParameterChoice>(SNARE_MIDI_NOTE_ID, SNARE_MIDI_NOTE_NAME, juce::StringArray(processorMidiNotes), 60 + 12);
    auto snareFlamNoteParam = std::make_unique<juce::AudioParameterChoice>(SNARE_FLAM_MIDI_NOTE_ID, SNARE_FLAM_MIDI_NOTE_NAME, juce::StringArray(processorMidiNotes), 61 + 12);
    auto snareRoundNoteParam = std::make_unique<juce::AudioParameterChoice>(SNARE_ROUND_MIDI_NOTE_ID, SNARE_ROUND_MIDI_NOTE_NAME, juce::StringArray(processorMidiNotes), 62 + 12);
    auto snareWirelessNoteParam = std::make_unique<juce::AudioParameterChoice>(SNARE_WIRELESS_MIDI_NOTE_ID, SNARE_WIRELESS_MIDI_NOTE_NAME, juce::StringArray(processorMidiNotes), 63 + 12);
    auto snareWirelessRoundNoteParam = std::make_unique<juce::AudioParameterChoice>(SNARE_WIRELESS_ROUND_MIDI_NOTE_ID, SNARE_WIRELESS_ROUND_MIDI_NOTE_NAME, juce::StringArray(processorMidiNotes), 64 + 12);
    auto tomNoteParam = std::make_unique<juce::AudioParameterChoice>(TOM_MIDI_NOTE_ID, TOM_MIDI_NOTE_NAME, juce::StringArray(processorMidiNotes), 66 + 12);
    auto tomFlamNoteParam = std::make_unique<juce::AudioParameterChoice>(TOM_FLAM_MIDI_NOTE_ID, TOM_FLAM_MIDI_NOTE_NAME, juce::StringArray(processorMidiNotes), 67 + 12);
    auto ftomNoteParam = std::make_unique<juce::AudioParameterChoice>(FTOM_MIDI_NOTE_ID, FTOM_MIDI_NOTE_NAME, juce::StringArray(processorMidiNotes), 68 + 12);
    auto ftomFlamNoteParam = std::make_unique<juce::AudioParameterChoice>(FTOM_FLAM_MIDI_NOTE_ID, FTOM_FLAM_MIDI_NOTE_NAME, juce::StringArray(processorMidiNotes), 69 + 12);
    auto tambNoteParam = std::make_unique<juce::AudioParameterChoice>(TAMB_MIDI_NOTE_ID, TAMB_MIDI_NOTE_NAME, juce::StringArray(processorMidiNotes), 71 + 12);
...
void HDrumsAudioProcessor::loadSamples(int samplePackID)
{
    ...
    if (samplePackID == 1) {
        ...
        addSample("Ride Hard", destinationP + "Ride Hard.wav", 65 + 12, curveFor6[0], 127, 5.0, 8.0, "Close");
        addSample("Ride Smooth", destinationP + "Ride Smooth.wav", 65 + 12, 1, curveFor6[0] - 1, 0.5, 8.0, "Close");
        string GGDdestination = destinationP + "GGD/";
        addSample("HH open", GGDdestination + "HH open.wav", 64 + 12, 1, 127, 0.12, 6.5, "Close");
        addSample("HH closed", GGDdestination + "HH closed.wav", 62 + 12, 1, 127, 0.1, 2.0, "Close");

        string snareDestination = destinationP + "Konrad1/Snare/";
        addSample("Snare 1_1", snareDestination + "Snare 1_1.wav", 60 + 12, curveFor6[4], 128, snareRelease, snareMaxLen, "Close");
        addSample("Snare 2_1", snareDestination + "Snare 2_1.wav", 60 + 12, curveFor6[3], curveFor6[4] - 1, snareRelease, snareMaxLen, "Close");
        addSample("Snare 3_1", snareDestination + "Snare 3_1.wav", 60 + 12, curveFor6[2], curveFor6[3] - 1, snareRelease, snareMaxLen, "Close");
        addSample("Snare 4_1", snareDestination + "Snare 4_1.wav", 60 + 12, curveFor6[1], curveFor6[2] - 1, snareRelease, snareMaxLen, "Close");
        addSample("Snare 5_1", snareDestination + "Snare 5_1.wav", 60 + 12, curveFor6[0], curveFor6[1] - 1, snareRelease, snareMaxLen, "Close");
        addSample("Snare 6_1", snareDestination + "Snare 6_1.wav", 60 + 12, 1, curveFor6[0] - 1, snareRelease, snareMaxLen, "Close");
        string kickDestination = destinationP + "Konrad1/Kick/";
        addSample("Kick 0_1", kickDestination + "Kick 0_1.wav", 59 + 12, 126, 127, 0.6, 2.0, "Close");
        addSample("Kick 1_1", kickDestination + "Kick 1_1.wav", 59 + 12, 114, 125, 0.6, 2.0, "Close");
        addSample("Kick 2_1", kickDestination + "Kick 2_1.wav", 59 + 12, 100, 113, 0.6, 2.0, "Close");
        addSample("Kick 3_1", kickDestination + "Kick 3_1.wav", 59 + 12, 85, 99, 0.6, 2.0, "Close");
        addSample("Kick 4_1", kickDestination + "Kick 4_1.wav", 59 + 12, 75, 84, 0.6, 2.0, "Close");
        addSample("Kick 5_1", kickDestination + "Kick 5_1.wav", 59 + 12, 66, 74, 0.6, 2.0, "Close");
        addSample("Kick 6_1", kickDestination + "Kick 6_1.wav", 59 + 12, 40, 65, 0.6, 2.0, "Close");
        addSample("Kick 7_1", kickDestination + "Kick 7_1.wav", 59 + 12, 1, 39, 0.6, 2.0, "Close");
        string FTCloseDestination = destinationP + "Konrad1/FT/Close/";
        addSample("FT Close 1_1", FTCloseDestination + "FT Close 1_1.wav", 67 + 12, 1, 127, 0.7, 1.5, "Close");
        string FTOHDestination = destinationP + "Konrad1/FT/OH/";
        addSample("FT OH 1_1", FTOHDestination + "FT OH 1_1.wav", 67 + 12, 1, 127, 0.7, 1.5, "OH");
    }
        ...
        addSample("Leaf Kick + Crash", LeafDestination + "Leaf Kick + Crash.wav", 65 + 12, 1, 127, 5.0, 8.0, "Close");
        addSample("Leaf Kick", LeafDestination + "Leaf Kick.wav", 59 + 12, 1, 127, 0.6, 2.0, "Close");
        addSample("Leaf Snare", LeafDestination + "Leaf Snare.wav", 60 + 12, 1, 127, 0.5, 2.0, "Close");
        addSample("Leaf Trap Hat", LeafDestination + "Leaf Trap Hat.wav", 64 + 12, 1, 127, 0.12, 6.5, "Close");
        addSample("Leaf Hat", LeafDestination + "Leaf Hat.wav", 62 + 12, 1, 127, 0.1, 2.0, "Close");
    }
        ...
        addSample("Kick 1 Close", kickDestination + "kick_1_close.wav", 59 + 12, curveFor6[0], curveFor6[1] - 1, kickRelease, kickMaxLen, "KickClose");
        addSample("Kick 2 Close", kickDestination + "kick_2_close.wav", 59 + 12, curveFor6[1], curveFor6[2] - 1, kickRelease, kickMaxLen, "KickClose");
        addSample("Kick 3 Close", kickDestination + "kick_3_close.wav", 59 + 12, curveFor6[2], curveFor6[3] - 1, kickRelease, kickMaxLen, "KickClose");
        addSample("Kick 4 Close", kickDestination + "kick_4_close.wav", 59 + 12, curveFor6[3], curveFor6[4] - 1, kickRelease, kickMaxLen, "KickClose");
        addSample("Kick 5 Close", kickDestination + "kick_5_close.wav", 59 + 12, curveFor6[4], curveFor6[5] - 1, kickRelease, kickMaxLen, "KickClose");
        addSample("Kick 6 Close", kickDestination + "kick_6_close.wav", 59 + 12, curveFor6[5], curveFor6[6] - 1, kickRelease, kickMaxLen, "KickClose");
        addSample("Kick 1 OH", kickDestination + "kick_1_OH.wav", 59 + 12, curveFor6[0], curveFor6[1] - 1, kickRelease, kickMaxLen, "KickOH");
        addSample("Kick 2 OH", kickDestination + "kick_2_OH.wav", 59 + 12, curveFor6[1], curveFor6[2] - 1, kickRelease, kickMaxLen, "KickOH");
        addSample("Kick 3 OH", kickDestination + "kick_3_OH.wav", 59 + 12, curveFor6[2], curveFor6[3] - 1, kickRelease, kickMaxLen, "KickOH");
        addSample("Kick 4 OH", kickDestination + "kick_4_OH.wav", 59 + 12, curveFor6[3], curveFor6[4] - 1, kickRelease, kickMaxLen, "KickOH");
        addSample("Kick 5 OH", kickDestination + "kick_5_OH.wav", 59 + 12, curveFor6[4], curveFor6[5] - 1, kickRelease, kickMaxLen, "KickOH");
        addSample("Kick 6 OH", kickDestination + "kick_6_OH.wav", 59 + 12, curveFor6[5], curveFor6[6] - 1, kickRelease, kickMaxLen, "KickOH");
        addSample("Kick 1 Room", kickDestination + "kick_1_room.wav", 59 + 12, curveFor6[0], curveFor6[1] - 1, kickRelease, kickMaxLen, "KickRoom");
        addSample("Kick 2 Room", kickDestination + "kick_2_room.wav", 59 + 12, curveFor6[1], curveFor6[2] - 1, kickRelease, kickMaxLen, "KickRoom");
        addSample("Kick 3 Room", kickDestination + "kick_3_room.wav", 59 + 12, curveFor6[2], curveFor6[3] - 1, kickRelease, kickMaxLen, "KickRoom");
        addSample("Kick 4 Room", kickDestination + "kick_4_room.wav", 59 + 12, curveFor6[3], curveFor6[4] - 1, kickRelease, kickMaxLen, "KickRoom");
        addSample("Kick 5 Room", kickDestination + "kick_5_room.wav", 59 + 12, curveFor6[4], curveFor6[5] - 1, kickRelease, kickMaxLen, "KickRoom");
        addSample("Kick 6 Room", kickDestination + "kick_6_room.wav", 59 + 12, curveFor6[5], curveFor6[6] - 1, kickRelease, kickMaxLen, "KickRoom");
        addSample("Kick 1 Bleed", kickDestination + "kick_1_bleed.wav", 59 + 12, curveFor6[0], curveFor6[1] - 1, kickRelease, kickMaxLen, "KickBleed");
        addSample("Kick 2 Bleed", kickDestination + "kick_2_bleed.wav", 59 + 12, curveFor6[1], curveFor6[2] - 1, kickRelease, kickMaxLen, "KickBleed");
        addSample("Kick 3 Bleed", kickDestination + "kick_3_bleed.wav", 59 + 12, curveFor6[2], curveFor6[3] - 1, kickRelease, kickMaxLen, "KickBleed");
        addSample("Kick 4 Bleed", kickDestination + "kick_4_bleed.wav", 59 + 12, curveFor6[3], curveFor6[4] - 1, kickRelease, kickMaxLen, "KickBleed");
        addSample("Kick 5 Bleed", kickDestination + "kick_5_bleed.wav", 59 + 12, curveFor6[4], curveFor6[5] - 1, kickRelease, kickMaxLen, "KickBleed");
        addSample("Kick 6 Bleed", kickDestination + "kick_6_bleed.wav", 59 + 12, curveFor6[5], curveFor6[6] - 1, kickRelease, kickMaxLen, "KickBleed");
        ...
        addSample("Snare 1 Top", snareDestination + "snare_1_top.wav", 60 + 12, curveFor6[0], curveFor6[1] - 1, snareRelease, 1.0, "SnareTop");
        addSample("Snare 2 Top", snareDestination + "snare_2_top.wav", 60 + 12, curveFor6[1], curveFor6[2] - 1, snareRelease, 1.1, "SnareTop");
        addSample("Snare 3 Top", snareDestination + "snare_3_top.wav", 60 + 12, curveFor6[2], curveFor6[3] - 1, snareRelease, 1.3, "SnareTop");
        addSample("Snare 4 Top", snareDestination + "snare_4_top.wav", 60 + 12, curveFor6[3], curveFor6[4] - 1, snareRelease, 1.3, "SnareTop");
        addSample("Snare 5 Top", snareDestination + "snare_5_top.wav", 60 + 12, curveFor6[4], curveFor6[5] - 1, snareRelease, 1.5, "SnareTop");
        addSample("Snare 6 Top", snareDestination + "snare_6_top.wav", 60 + 12, curveFor6[5], curveFor6[6] - 1, snareRelease, 1.8, "SnareTop");
        addSample("Snare 1 Bot", snareDestination + "snare_1_bot.wav", 60 + 12, curveFor6[0], curveFor6[1] - 1, snareRelease, 1.0, "SnareBot");
        addSample("Snare 2 Bot", snareDestination + "snare_2_bot.wav", 60 + 12, curveFor6[1], curveFor6[2] - 1, snareRelease, 1.1, "SnareBot");
        addSample("Snare 3 Bot", snareDestination + "snare_3_bot.wav", 60 + 12, curveFor6[2], curveFor6[3] - 1, snareRelease, 1.3, "SnareBot");
        addSample("Snare 4 Bot", snareDestination + "snare_4_bot.wav", 60 + 12, curveFor6[3], curveFor6[4] - 1, snareRelease, 1.3, "SnareBot");
        addSample("Snare 5 Bot", snareDestination + "snare_5_bot.wav", 60 + 12, curveFor6[4], curveFor6[5] - 1, snareRelease, 1.5, "SnareBot");
        addSample("Snare 6 Bot", snareDestination + "snare_6_bot.wav", 60 + 12, curveFor6[5], curveFor6[6] - 1, snareRelease, 1.8, "SnareBot");
        addSample("Snare 1 OH", snareDestination + "snare_1_OH.wav", 60 + 12, curveFor6[0], curveFor6[1] - 1, snareRelease, 1.0, "SnareOH");
        addSample("Snare 2 OH", snareDestination + "snare_2_OH.wav", 60 + 12, curveFor6[1], curveFor6[2] - 1, snareRelease, 1.1, "SnareOH");
        addSample("Snare 3 OH", snareDestination + "snare_3_OH.wav", 60 + 12, curveFor6[2], curveFor6[3] - 1, snareRelease, 1.3, "SnareOH");
        addSample("Snare 4 OH", snareDestination + "snare_4_OH.wav", 60 + 12, curveFor6[3], curveFor6[4] - 1, snareRelease, 1.3, "SnareOH");
        addSample("Snare 5 OH", snareDestination + "snare_5_OH.wav", 60 + 12, curveFor6[4], curveFor6[5] - 1, snareRelease, 1.5, "SnareOH");
        addSample("Snare 6 OH", snareDestination + "snare_6_OH.wav", 60 + 12, curveFor6[5], curveFor6[6] - 1, snareRelease, 1.8, "SnareOH");
        addSample("Snare 1 Room", snareDestination + "snare_1_room.wav", 60 + 12, curveFor6[0], curveFor6[1] - 1, snareRelease, 1.0, "SnareRoom");
        addSample("Snare 2 Room", snareDestination + "snare_2_room.wav", 60 + 12, curveFor6[1], curveFor6[2] - 1, snareRelease, 1.1, "SnareRoom");
        addSample("Snare 3 Room", snareDestination + "snare_3_room.wav", 60 + 12, curveFor6[2], curveFor6[3] - 1, snareRelease, 1.3, "SnareRoom");
        addSample("Snare 4 Room", snareDestination + "snare_4_room.wav", 60 + 12, curveFor6[3], curveFor6[4] - 1, snareRelease, 1.3, "SnareRoom");
        addSample("Snare 5 Room", snareDestination + "snare_5_room.wav", 60 + 12, curveFor6[4], curveFor6[5] - 1, snareRelease, 1.5, "SnareRoom");
        addSample("Snare 6 Room", snareDestination + "snare_6_room.wav", 60 + 12, curveFor6[5], curveFor6[6] - 1, snareRelease, 1.8, "SnareRoom");
        addSample("Snare 1 Bleed", snareDestination + "snare_1_bleed.wav", 60 + 12, curveFor6[0], curveFor6[1] - 1, snareRelease, 1.0, "SnareBleed");
        addSample("Snare 2 Bleed", snareDestination + "snare_2_bleed.wav", 60 + 12, curveFor6[1], curveFor6[2] - 1, snareRelease, 1.1, "SnareBleed");
        addSample("Snare 3 Bleed", snareDestination + "snare_3_bleed.wav", 60 + 12, curveFor6[2], curveFor6[3] - 1, snareRelease, 1.3, "SnareBleed");
        addSample("Snare 4 Bleed", snareDestination + "snare_4_bleed.wav", 60 + 12, curveFor6[3], curveFor6[4] - 1, snareRelease, 1.3, "SnareBleed");
        addSample("Snare 5 Bleed", snareDestination + "snare_5_bleed.wav", 60 + 12, curveFor6[4], curveFor6[5] - 1, snareRelease, 1.5, "SnareBleed");
        addSample("Snare 6 Bleed", snareDestination + "snare_6_bleed.wav", 60 + 12, curveFor6[5], curveFor6[6] - 1, snareRelease, 1.8, "SnareBleed");

        string snareFlamDestination = snareAllDestination + "snareFlam/";
        addSample("SnareFlam 1 Top", snareFlamDestination + "snareFlam_1_top.wav", 61 + 12, curveFor5[0], curveFor5[1] - 1, snareRelease, 1.8, "SnareTop");
        addSample("SnareFlam 2 Top", snareFlamDestination + "snareFlam_2_top.wav", 61 + 12, curveFor5[1], curveFor5[2] - 1, snareRelease, 1.3, "SnareTop");
        addSample("SnareFlam 3 Top", snareFlamDestination + "snareFlam_3_top.wav", 61 + 12, curveFor5[2], curveFor5[3] - 1, snareRelease, 1.3, "SnareTop");
        addSample("SnareFlam 4 Top", snareFlamDestination + "snareFlam_4_top.wav", 61 + 12, curveFor5[3], curveFor5[4] - 1, snareRelease, 1.4, "SnareTop");
        addSample("SnareFlam 5 Top", snareFlamDestination + "snareFlam_5_top.wav", 61 + 12, curveFor5[4], curveFor5[5] - 1, snareRelease, 1.0, "SnareTop");
        addSample("SnareFlam 1 Bot", snareFlamDestination + "snareFlam_1_bot.wav", 61 + 12, curveFor5[0], curveFor5[1] - 1, snareRelease, 1.8, "SnareBot");
        addSample("SnareFlam 2 Bot", snareFlamDestination + "snareFlam_2_bot.wav", 61 + 12, curveFor5[1], curveFor5[2] - 1, snareRelease, 1.3, "SnareBot");
        addSample("SnareFlam 3 Bot", snareFlamDestination + "snareFlam_3_bot.wav", 61 + 12, curveFor5[2], curveFor5[3] - 1, snareRelease, 1.3, "SnareBot");
        addSample("SnareFlam 4 Bot", snareFlamDestination + "snareFlam_4_bot.wav", 61 + 12, curveFor5[3], curveFor5[4] - 1, snareRelease, 1.4, "SnareBot");
        addSample("SnareFlam 5 Bot", snareFlamDestination + "snareFlam_5_bot.wav", 61 + 12, curveFor5[4], curveFor5[5] - 1, snareRelease, 1.0, "SnareBot");
        addSample("SnareFlam 1 OH", snareFlamDestination + "snareFlam_1_OH.wav", 61 + 12, curveFor5[0], curveFor5[1] - 1, snareRelease, 1.8, "SnareOH");
        addSample("SnareFlam 2 OH", snareFlamDestination + "snareFlam_2_OH.wav", 61 + 12, curveFor5[1], curveFor5[2] - 1, snareRelease, 1.3, "SnareOH");
        addSample("SnareFlam 3 OH", snareFlamDestination + "snareFlam_3_OH.wav", 61 + 12, curveFor5[2], curveFor5[3] - 1, snareRelease, 1.3, "SnareOH");
        addSample("SnareFlam 4 OH", snareFlamDestination + "snareFlam_4_OH.wav", 61 + 12, curveFor5[3], curveFor5[4] - 1, snareRelease, 1.4, "SnareOH");
        addSample("SnareFlam 5 OH", snareFlamDestination + "snareFlam_5_OH.wav", 61 + 12, curveFor5[4], curveFor5[5] - 1, snareRelease, 1.0, "SnareOH");
        addSample("SnareFlam 1 Room", snareFlamDestination + "snareFlam_1_room.wav", 61 + 12, curveFor5[0], curveFor5[1] - 1, snareRelease, 1.8, "SnareRoom");
        addSample("SnareFlam 2 Room", snareFlamDestination + "snareFlam_2_room.wav", 61 + 12, curveFor5[1], curveFor5[2] - 1, snareRelease, 1.3, "SnareRoom");
        addSample("SnareFlam 3 Room", snareFlamDestination + "snareFlam_3_room.wav", 61 + 12, curveFor5[2], curveFor5[3] - 1, snareRelease, 1.3, "SnareRoom");
        addSample("SnareFlam 4 Room", snareFlamDestination + "snareFlam_4_room.wav", 61 + 12, curveFor5[3], curveFor5[4] - 1, snareRelease, 1.4, "SnareRoom");
        addSample("SnareFlam 5 Room", snareFlamDestination + "snareFlam_5_room.wav", 61 + 12, curveFor5[4], curveFor5[5] - 1, snareRelease, 1.0, "SnareRoom");
        addSample("SnareFlam 1 Bleed", snareFlamDestination + "snareFlam_1_bleed.wav", 61 + 12, curveFor5[0], curveFor5[1] - 1, snareRelease, 1.8, "SnareBleed");
        addSample("SnareFlam 2 Bleed", snareFlamDestination + "snareFlam_2_bleed.wav", 61 + 12, curveFor5[1], curveFor5[2] - 1, snareRelease, 1.3, "SnareBleed");
        addSample("SnareFlam 3 Bleed", snareFlamDestination + "snareFlam_3_bleed.wav", 61 + 12, curveFor5[2], curveFor5[3] - 1, snareRelease, 1.3, "SnareBleed");
        addSample("SnareFlam 4 Bleed", snareFlamDestination + "snareFlam_4_bleed.wav", 61 + 12, curveFor5[3], curveFor5[4] - 1, snareRelease, 1.4, "SnareBleed");
        addSample("SnareFlam 5 Bleed", snareFlamDestination + "snareFlam_5_bleed.wav", 61 + 12, curveFor5[4], curveFor5[5] - 1, snareRelease, 1.0, "SnareBleed");

        double snareMaxLen2 = 1.1;
        string snareRoundDestination = snareAllDestination + "snareRound/";
        addSample("SnareRound 1 Top", snareRoundDestination + "snareRound_1_top.wav", 62 + 12, curveFor4[0], curveFor4[1] - 1, snareRelease, snareMaxLen2, "SnareTop");
        addSample("SnareRound 2 Top", snareRoundDestination + "snareRound_2_top.wav", 62 + 12, curveFor4[1], curveFor4[2] - 1, snareRelease, snareMaxLen2, "SnareTop");
        addSample("SnareRound 3 Top", snareRoundDestination + "snareRound_3_top.wav", 62 + 12, curveFor4[2], curveFor4[3] - 1, snareRelease, snareMaxLen2, "SnareTop");
        addSample("SnareRound 4 Top", snareRoundDestination + "snareRound_4_top.wav", 62 + 12, curveFor4[3], curveFor4[4] - 1, snareRelease, snareMaxLen2, "SnareTop");
        addSample("SnareRound 1 Bot", snareRoundDestination + "snareRound_1_bot.wav", 62 + 12, curveFor4[0], curveFor4[1] - 1, snareRelease, snareMaxLen2, "SnareBot");
        addSample("SnareRound 2 Bot", snareRoundDestination + "snareRound_2_bot.wav", 62 + 12, curveFor4[1], curveFor4[2] - 1, snareRelease, snareMaxLen2, "SnareBot");
        addSample("SnareRound 3 Bot", snareRoundDestination + "snareRound_3_bot.wav", 62 + 12, curveFor4[2], curveFor4[3] - 1, snareRelease, snareMaxLen2, "SnareBot");
        addSample("SnareRound 4 Bot", snareRoundDestination + "snareRound_4_bot.wav", 62 + 12, curveFor4[3], curveFor4[4] - 1, snareRelease, snareMaxLen2, "SnareBot");
        addSample("SnareRound 1 OH", snareRoundDestination + "snareRound_1_OH.wav", 62 + 12, curveFor4[0], curveFor4[1] - 1, snareRelease, snareMaxLen2, "SnareOH");
        addSample("SnareRound 2 OH", snareRoundDestination + "snareRound_2_OH.wav", 62 + 12, curveFor4[1], curveFor4[2] - 1, snareRelease, snareMaxLen2, "SnareOH");
        addSample("SnareRound 3 OH", snareRoundDestination + "snareRound_3_OH.wav", 62 + 12, curveFor4[2], curveFor4[3] - 1, snareRelease, snareMaxLen2, "SnareOH");
        addSample("SnareRound 4 OH", snareRoundDestination + "snareRound_4_OH.wav", 62 + 12, curveFor4[3], curveFor4[4] - 1, snareRelease, snareMaxLen2, "SnareOH");
        addSample("SnareRound 1 Room", snareRoundDestination + "snareRound_1_room.wav", 62 + 12, curveFor4[0], curveFor4[1] - 1, snareRelease, snareMaxLen2, "SnareRoom");
        addSample("SnareRound 2 Room", snareRoundDestination + "snareRound_2_room.wav", 62 + 12, curveFor4[1], curveFor4[2] - 1, snareRelease, snareMaxLen2, "SnareRoom");
        addSample("SnareRound 3 Room", snareRoundDestination + "snareRound_3_room.wav", 62 + 12, curveFor4[2], curveFor4[3] - 1, snareRelease, snareMaxLen2, "SnareRoom");
        addSample("SnareRound 4 Room", snareRoundDestination + "snareRound_4_room.wav", 62 + 12, curveFor4[3], curveFor4[4] - 1, snareRelease, snareMaxLen2, "SnareRoom");
        addSample("SnareRound 1 Bleed", snareRoundDestination + "snareRound_1_bleed.wav", 62 + 12, curveFor4[0], curveFor4[1] - 1, snareRelease, snareMaxLen2, "SnareBleed");
        addSample("SnareRound 2 Bleed", snareRoundDestination + "snareRound_2_bleed.wav", 62 + 12, curveFor4[1], curveFor4[2] - 1, snareRelease, snareMaxLen2, "SnareBleed");
        addSample("SnareRound 3 Bleed", snareRoundDestination + "snareRound_3_bleed.wav", 62 + 12, curveFor4[2], curveFor4[3] - 1, snareRelease, snareMaxLen2, "SnareBleed");
        addSample("SnareRound 4 Bleed", snareRoundDestination + "snareRound_4_bleed.wav", 62 + 12, curveFor4[3], curveFor4[4] - 1, snareRelease, snareMaxLen2, "SnareBleed");

        string snareWirelessDestination = snareAllDestination + "snareWireless/";
        addSample("SnareWireless 1 Top", snareWirelessDestination + "snareWireless_1_top.wav", 63 + 12, curveFor4[0], curveFor4[1] - 1, snareRelease, 0.75, "SnareTop");
        addSample("SnareWireless 2 Top", snareWirelessDestination + "snareWireless_2_top.wav", 63 + 12, curveFor4[1], curveFor4[2] - 1, snareRelease, 0.75, "SnareTop");
        addSample("SnareWireless 3 Top", snareWirelessDestination + "snareWireless_3_top.wav", 63 + 12, curveFor4[2], curveFor4[3] - 1, snareRelease, 0.99, "SnareTop");
        addSample("SnareWireless 4 Top", snareWirelessDestination + "snareWireless_4_top.wav", 63 + 12, curveFor4[3], curveFor4[4] - 1, snareRelease, 0.99, "SnareTop");
        addSample("SnareWireless 1 Bot", snareWirelessDestination + "snareWireless_1_bot.wav", 63 + 12, curveFor4[0], curveFor4[1] - 1, snareRelease, 0.75, "SnareBot");
        addSample("SnareWireless 2 Bot", snareWirelessDestination + "snareWireless_2_bot.wav", 63 + 12, curveFor4[1], curveFor4[2] - 1, snareRelease, 0.75, "SnareBot");
        addSample("SnareWireless 3 Bot", snareWirelessDestination + "snareWireless_3_bot.wav", 63 + 12, curveFor4[2], curveFor4[3] - 1, snareRelease, 0.99, "SnareBot");
        addSample("SnareWireless 4 Bot", snareWirelessDestination + "snareWireless_4_bot.wav", 63 + 12, curveFor4[3], curveFor4[4] - 1, snareRelease, 0.99, "SnareBot");
        addSample("SnareWireless 1 OH", snareWirelessDestination + "snareWireless_1_OH.wav", 63 + 12, curveFor4[0], curveFor4[1] - 1, snareRelease, 0.75, "SnareOH");
        addSample("SnareWireless 2 OH", snareWirelessDestination + "snareWireless_2_OH.wav", 63 + 12, curveFor4[1], curveFor4[2] - 1, snareRelease, 0.75, "SnareOH");
        addSample("SnareWireless 3 OH", snareWirelessDestination + "snareWireless_3_OH.wav", 63 + 12, curveFor4[2], curveFor4[3] - 1, snareRelease, 0.99, "SnareOH");
        addSample("SnareWireless 4 OH", snareWirelessDestination + "snareWireless_4_OH.wav", 63 + 12, curveFor4[3], curveFor4[4] - 1, snareRelease, 0.99, "SnareOH");
        addSample("SnareWireless 1 Room", snareWirelessDestination + "snareWireless_1_room.wav", 63 + 12, curveFor4[0], curveFor4[1] - 1, snareRelease, 0.75, "SnareRoom");
        addSample("SnareWireless 2 Room", snareWirelessDestination + "snareWireless_2_room.wav", 63 + 12, curveFor4[1], curveFor4[2] - 1, snareRelease, 0.75, "SnareRoom");
        addSample("SnareWireless 3 Room", snareWirelessDestination + "snareWireless_3_room.wav", 63 + 12, curveFor4[2], curveFor4[3] - 1, snareRelease, 0.99, "SnareRoom");
        addSample("SnareWireless 4 Room", snareWirelessDestination + "snareWireless_4_room.wav", 63 + 12, curveFor4[3], curveFor4[4] - 1, snareRelease, 0.99, "SnareRoom");
        addSample("SnareWireless 1 Bleed", snareWirelessDestination + "snareWireless_1_bleed.wav", 63 + 12, curveFor4[0], curveFor4[1] - 1, snareRelease, 0.75, "SnareBleed");
        addSample("SnareWireless 2 Bleed", snareWirelessDestination + "snareWireless_2_bleed.wav", 63 + 12, curveFor4[1], curveFor4[2] - 1, snareRelease, 0.75, "SnareBleed");
        addSample("SnareWireless 3 Bleed", snareWirelessDestination + "snareWireless_3_bleed.wav", 63 + 12, curveFor4[2], curveFor4[3] - 1, snareRelease, 0.99, "SnareBleed");
        addSample("SnareWireless 4 Bleed", snareWirelessDestination + "snareWireless_4_bleed.wav", 63 + 12, curveFor4[3], curveFor4[4] - 1, snareRelease, 0.99, "SnareBleed");

        string snareWirelessRoundDestination = snareAllDestination + "snareWirelessRound/";
        addSample("SnareWirelessRound 1 Top", snareWirelessRoundDestination + "snareWirelessRound_1_top.wav", 64 + 12, curveFor4[0], curveFor4[1] - 1, snareRelease, 0.5, "SnareTop");
        addSample("SnareWirelessRound 2 Top", snareWirelessRoundDestination + "snareWirelessRound_2_top.wav", 64 + 12, curveFor4[1], curveFor4[2] - 1, snareRelease, 0.5, "SnareTop");
        addSample("SnareWirelessRound 3 Top", snareWirelessRoundDestination + "snareWirelessRound_3_top.wav", 64 + 12, curveFor4[2], curveFor4[3] - 1, snareRelease, 0.5, "SnareTop");
        addSample("SnareWirelessRound 4 Top", snareWirelessRoundDestination + "snareWirelessRound_4_top.wav", 64 + 12, curveFor4[3], curveFor4[4] - 1, snareRelease, 0.6, "SnareTop");
        addSample("SnareWirelessRound 1 Bot", snareWirelessRoundDestination + "snareWirelessRound_1_bot.wav", 64 + 12, curveFor4[0], curveFor4[1] - 1, snareRelease, 0.5, "SnareBot");
        addSample("SnareWirelessRound 2 Bot", snareWirelessRoundDestination + "snareWirelessRound_2_bot.wav", 64 + 12, curveFor4[1], curveFor4[2] - 1, snareRelease, 0.5, "SnareBot");
        addSample("SnareWirelessRound 3 Bot", snareWirelessRoundDestination + "snareWirelessRound_3_bot.wav", 64 + 12, curveFor4[2], curveFor4[3] - 1, snareRelease, 0.5, "SnareBot");
        addSample("SnareWirelessRound 4 Bot", snareWirelessRoundDestination + "snareWirelessRound_4_bot.wav", 64 + 12, curveFor4[3], curveFor4[4] - 1, snareRelease, 0.6, "SnareBot");
        addSample("SnareWirelessRound 1 OH", snareWirelessRoundDestination + "snareWirelessRound_1_OH.wav", 64 + 12, curveFor4[0], curveFor4[1] - 1, snareRelease, 0.5, "SnareOH");
        addSample("SnareWirelessRound 2 OH", snareWirelessRoundDestination + "snareWirelessRound_2_OH.wav", 64 + 12, curveFor4[1], curveFor4[2] - 1, snareRelease, 0.5, "SnareOH");
        addSample("SnareWirelessRound 3 OH", snareWirelessRoundDestination + "snareWirelessRound_3_OH.wav", 64 + 12, curveFor4[2], curveFor4[3] - 1, snareRelease, 0.5, "SnareOH");
        addSample("SnareWirelessRound 4 OH", snareWirelessRoundDestination + "snareWirelessRound_4_OH.wav", 64 + 12, curveFor4[3], curveFor4[4] - 1, snareRelease, 0.6, "SnareOH");
        addSample("SnareWirelessRound 1 Room", snareWirelessRoundDestination + "snareWirelessRound_1_room.wav", 64 + 12, curveFor4[0], curveFor4[1] - 1, snareRelease, 0.5, "SnareRoom");
        addSample("SnareWirelessRound 2 Room", snareWirelessRoundDestination + "snareWirelessRound_2_room.wav", 64 + 12, curveFor4[1], curveFor4[2] - 1, snareRelease, 0.5, "SnareRoom");
        addSample("SnareWirelessRound 3 Room", snareWirelessRoundDestination + "snareWirelessRound_3_room.wav", 64 + 12, curveFor4[2], curveFor4[3] - 1, snareRelease, 0.5, "SnareRoom");
        addSample("SnareWirelessRound 4 Room", snareWirelessRoundDestination + "snareWirelessRound_4_room.wav", 64 + 12, curveFor4[3], curveFor4[4] - 1, snareRelease, 0.6, "SnareRoom");
        addSample("SnareWirelessRound 1 Bleed", snareWirelessRoundDestination + "snareWirelessRound_1_bleed.wav", 64, curveFor4[0], curveFor4[1] - 1, snareRelease, 0.5, "SnareBleed");
        addSample("SnareWirelessRound 2 Bleed", snareWirelessRoundDestination + "snareWirelessRound_2_bleed.wav", 64, curveFor4[1], curveFor4[2] - 1, snareRelease, 0.5, "SnareBleed");
        addSample("SnareWirelessRound 3 Bleed", snareWirelessRoundDestination + "snareWirelessRound_3_bleed.wav", 64, curveFor4[2], curveFor4[3] - 1, snareRelease, 0.5, "SnareBleed");
        addSample("SnareWirelessRound 4 Bleed", snareWirelessRoundDestination + "snareWirelessRound_4_bleed.wav", 64, curveFor4[3], curveFor4[4] - 1, snareRelease, 0.6, "SnareBleed");
        ...
        addSample("Tom 1 Close", tomDestination + "tom_1_close.wav", 66 + 12, curveFor5[0], curveFor5[1] - 1, tomRelease, 0.7, "TomClose");
        addSample("Tom 2 Close", tomDestination + "tom_2_close.wav", 66 + 12, curveFor5[1], curveFor5[2] - 1, tomRelease, 0.7, "TomClose");
        addSample("Tom 3 Close", tomDestination + "tom_3_close.wav", 66 + 12, curveFor5[2], curveFor5[3] - 1, tomRelease, 0.9, "TomClose");
        addSample("Tom 4 Close", tomDestination + "tom_4_close.wav", 66 + 12, curveFor5[3], curveFor5[4] - 1, tomRelease, 1.0, "TomClose");
        addSample("Tom 5 Close", tomDestination + "tom_5_close.wav", 66 + 12, curveFor5[4], curveFor5[5] - 1, tomRelease, 1.1, "TomClose");
        addSample("Tom 1 OH", tomDestination + "tom_1_OH.wav", 66 + 12, curveFor5[0], curveFor5[1] - 1, tomRelease, 0.7, "TomsOH");
        addSample("Tom 2 OH", tomDestination + "tom_2_OH.wav", 66 + 12, curveFor5[1], curveFor5[2] - 1, tomRelease, 0.7, "TomsOH");
        addSample("Tom 3 OH", tomDestination + "tom_3_OH.wav", 66 + 12, curveFor5[2], curveFor5[3] - 1, tomRelease, 0.9, "TomsOH");
        addSample("Tom 4 OH", tomDestination + "tom_4_OH.wav", 66 + 12, curveFor5[3], curveFor5[4] - 1, tomRelease, 1.0, "TomsOH");
        addSample("Tom 5 OH", tomDestination + "tom_5_OH.wav", 66 + 12, curveFor5[4], curveFor5[5] - 1, tomRelease, 1.1, "TomsOH");
        addSample("Tom 1 Room", tomDestination + "tom_1_room.wav", 66 + 12, curveFor5[0], curveFor5[1] - 1, tomRelease, 0.7, "TomsRoom");
        addSample("Tom 2 Room", tomDestination + "tom_2_room.wav", 66 + 12, curveFor5[1], curveFor5[2] - 1, tomRelease, 0.7, "TomsRoom");
        addSample("Tom 3 Room", tomDestination + "tom_3_room.wav", 66 + 12, curveFor5[2], curveFor5[3] - 1, tomRelease, 0.9, "TomsRoom");
        addSample("Tom 4 Room", tomDestination + "tom_4_room.wav", 66 + 12, curveFor5[3], curveFor5[4] - 1, tomRelease, 1.0, "TomsRoom");
        addSample("Tom 5 Room", tomDestination + "tom_5_room.wav", 66 + 12, curveFor5[4], curveFor5[5] - 1, tomRelease, 1.1, "TomsRoom");
        addSample("Tom 1 Bleed", tomDestination + "tom_1_bleed.wav", 66 + 12, curveFor5[0], curveFor5[1] - 1, tomRelease, 0.7, "TomsBleed");
        addSample("Tom 2 Bleed", tomDestination + "tom_2_bleed.wav", 66 + 12, curveFor5[1], curveFor5[2] - 1, tomRelease, 0.7, "TomsBleed");
        addSample("Tom 3 Bleed", tomDestination + "tom_3_bleed.wav", 66 + 12, curveFor5[2], curveFor5[3] - 1, tomRelease, 0.9, "TomsBleed");
        addSample("Tom 4 Bleed", tomDestination + "tom_4_bleed.wav", 66 + 12, curveFor5[3], curveFor5[4] - 1, tomRelease, 1.0, "TomsBleed");
        addSample("Tom 5 Bleed", tomDestination + "tom_5_bleed.wav", 66 + 12, curveFor5[4], curveFor5[5] - 1, tomRelease, 1.1, "TomsBleed");

        string tomFlamDestination = tomAllDestination + "tomFlam/";
        addSample("TomFlam 1 Close", tomFlamDestination + "tomFlam_1_close.wav", 67 + 12, curveFor3[0], curveFor3[1] - 1, tomRelease, 0.9, "TomClose");
        addSample("TomFlam 2 Close", tomFlamDestination + "tomFlam_2_close.wav", 67 + 12, curveFor3[1], curveFor3[2] - 1, tomRelease, 1.0, "TomClose");
        addSample("TomFlam 3 Close", tomFlamDestination + "tomFlam_3_close.wav", 67 + 12, curveFor3[2], curveFor3[3] - 1, tomRelease, 1.1, "TomClose");
        addSample("TomFlam 1 OH", tomFlamDestination + "tomFlam_1_OH.wav", 67 + 12, curveFor3[0], curveFor3[1] - 1, tomRelease, 0.9, "TomsOH");
        addSample("TomFlam 2 OH", tomFlamDestination + "tomFlam_2_OH.wav", 67 + 12, curveFor3[1], curveFor3[2] - 1, tomRelease, 1.0, "TomsOH");
        addSample("TomFlam 3 OH", tomFlamDestination + "tomFlam_3_OH.wav", 67 + 12, curveFor3[2], curveFor3[3] - 1, tomRelease, 1.1, "TomsOH");
        addSample("TomFlam 1 Room", tomFlamDestination + "tomFlam_1_room.wav", 67 + 12, curveFor3[0], curveFor3[1] - 1, tomRelease, 0.9, "TomsRoom");
        addSample("TomFlam 2 Room", tomFlamDestination + "tomFlam_2_room.wav", 67 + 12, curveFor3[1], curveFor3[2] - 1, tomRelease, 1.0, "TomsRoom");
        addSample("TomFlam 3 Room", tomFlamDestination + "tomFlam_3_room.wav", 67 + 12, curveFor3[2], curveFor3[3] - 1, tomRelease, 1.1, "TomsRoom");
        addSample("TomFlam 1 Bleed", tomFlamDestination + "tomFlam_1_bleed.wav", 67 + 12, curveFor3[0], curveFor3[1] - 1, tomRelease, 0.9, "TomsBleed");
        addSample("TomFlam 2 Bleed", tomFlamDestination + "tomFlam_2_bleed.wav", 67 + 12, curveFor3[1], curveFor3[2] - 1, tomRelease, 1.0, "TomsBleed");
        addSample("TomFlam 3 Bleed", tomFlamDestination + "tomFlam_3_bleed.wav", 67 + 12, curveFor3[2], curveFor3[3] - 1, tomRelease, 1.1, "TomsBleed");
        ...
        addSample("FTom 1 Close", ftomDestination + "ftom_1_close.wav", 68 + 12, curveFor5[0], curveFor5[1] - 1, ftomRelease, 0.4, "FTomClose");
        addSample("FTom 2 Close", ftomDestination + "ftom_2_close.wav", 68 + 12, curveFor5[1], curveFor5[2] - 1, ftomRelease, 0.9, "FTomClose");
        addSample("FTom 3 Close", ftomDestination + "ftom_3_close.wav", 68 + 12, curveFor5[2], curveFor5[3] - 1, ftomRelease, 0.9, "FTomClose");
        addSample("FTom 4 Close", ftomDestination + "ftom_4_close.wav", 68 + 12, curveFor5[3], curveFor5[4] - 1, ftomRelease, 1.0, "FTomClose");
        addSample("FTom 5 Close", ftomDestination + "ftom_5_close.wav", 68 + 12, curveFor5[4], curveFor5[5] - 1, ftomRelease, 1.0, "FTomClose");
        addSample("FTom 1 OH", ftomDestination + "ftom_1_OH.wav", 68 + 12, curveFor5[0], curveFor5[1] - 1, ftomRelease, 0.4, "TomsOH");
        addSample("FTom 2 OH", ftomDestination + "ftom_2_OH.wav", 68 + 12, curveFor5[1], curveFor5[2] - 1, ftomRelease, 0.9, "TomsOH");
        addSample("FTom 3 OH", ftomDestination + "ftom_3_OH.wav", 68 + 12, curveFor5[2], curveFor5[3] - 1, ftomRelease, 0.9, "TomsOH");
        addSample("FTom 4 OH", ftomDestination + "ftom_4_OH.wav", 68 + 12, curveFor5[3], curveFor5[4] - 1, ftomRelease, 1.0, "TomsOH");
        addSample("FTom 5 OH", ftomDestination + "ftom_5_OH.wav", 68 + 12, curveFor5[4], curveFor5[5] - 1, ftomRelease, 1.0, "TomsOH");
        addSample("FTom 1 Room", ftomDestination + "ftom_1_room.wav", 68 + 12, curveFor5[0], curveFor5[1] - 1, ftomRelease, 0.4, "TomsRoom");
        addSample("FTom 2 Room", ftomDestination + "ftom_2_room.wav", 68 + 12, curveFor5[1], curveFor5[2] - 1, ftomRelease, 0.9, "TomsRoom");
        addSample("FTom 3 Room", ftomDestination + "ftom_3_room.wav", 68 + 12, curveFor5[2], curveFor5[3] - 1, ftomRelease, 0.9, "TomsRoom");
        addSample("FTom 4 Room", ftomDestination + "ftom_4_room.wav", 68 + 12, curveFor5[3], curveFor5[4] - 1, ftomRelease, 1.0, "TomsRoom");
        addSample("FTom 5 Room", ftomDestination + "ftom_5_room.wav", 68 + 12, curveFor5[4], curveFor5[5] - 1, ftomRelease, 1.0, "TomsRoom");
        addSample("FTom 1 Bleed", ftomDestination + "ftom_1_bleed.wav", 68 + 12, curveFor5[0], curveFor5[1] - 1, tomRelease, 0.4, "TomsBleed");
        addSample("FTom 2 Bleed", ftomDestination + "ftom_2_bleed.wav", 68 + 12, curveFor5[1], curveFor5[2] - 1, tomRelease, 0.9, "TomsBleed");
        addSample("FTom 3 Bleed", ftomDestination + "ftom_3_bleed.wav", 68 + 12, curveFor5[2], curveFor5[3] - 1, tomRelease, 0.9, "TomsBleed");
        addSample("FTom 4 Bleed", ftomDestination + "ftom_4_bleed.wav", 68 + 12, curveFor5[3], curveFor5[4] - 1, tomRelease, 1.0, "TomsBleed");
        addSample("FTom 5 Bleed", ftomDestination + "ftom_5_bleed.wav", 68 + 12, curveFor5[4], curveFor5[5] - 1, tomRelease, 1.0, "TomsBleed");

        string ftomFlamDestination = ftomAllDestination + "ftomFlam/";
        addSample("FTomFlam 1 Close", ftomFlamDestination + "ftomFlam_1_close.wav", 69 + 12, curveFor3[0], curveFor3[1] - 1, ftomRelease, 0.9, "FTomClose");
        addSample("FTomFlam 2 Close", ftomFlamDestination + "ftomFlam_2_close.wav", 69 + 12, curveFor3[1], curveFor3[2] - 1, ftomRelease, 1.0, "FTomClose");
        addSample("FTomFlam 3 Close", ftomFlamDestination + "ftomFlam_3_close.wav", 69 + 12, curveFor3[2], curveFor3[3] - 1, ftomRelease, 1.1, "FTomClose");
        addSample("FTomFlam 1 OH", ftomFlamDestination + "ftomFlam_1_OH.wav", 69 + 12, curveFor3[0], curveFor3[1] - 1, ftomRelease, 0.9, "TomsOH");
        addSample("FTomFlam 2 OH", ftomFlamDestination + "ftomFlam_2_OH.wav", 69 + 12, curveFor3[1], curveFor3[2] - 1, ftomRelease, 1.0, "TomsOH");
        addSample("FTomFlam 3 OH", ftomFlamDestination + "ftomFlam_3_OH.wav", 69 + 12, curveFor3[2], curveFor3[3] - 1, ftomRelease, 1.1, "TomsOH");
        addSample("FTomFlam 1 Room", ftomFlamDestination + "ftomFlam_1_room.wav", 69 + 12, curveFor3[0], curveFor3[1] - 1, ftomRelease, 0.9, "TomsRoom");
        addSample("FTomFlam 2 Room", ftomFlamDestination + "ftomFlam_2_room.wav", 69 + 12, curveFor3[1], curveFor3[2] - 1, ftomRelease, 1.0, "TomsRoom");
        addSample("FTomFlam 3 Room", ftomFlamDestination + "ftomFlam_3_room.wav", 69 + 12, curveFor3[2], curveFor3[3] - 1, ftomRelease, 1.1, "TomsRoom");
        addSample("FTomFlam 1 Bleed", ftomFlamDestination + "ftomFlam_1_bleed.wav", 69 + 12, curveFor3[0], curveFor3[1] - 1, ftomRelease, 0.9, "TomsBleed");
        addSample("FTomFlam 2 Bleed", ftomFlamDestination + "ftomFlam_2_bleed.wav", 69 + 12, curveFor3[1], curveFor3[2] - 1, ftomRelease, 1.0, "TomsBleed");
        addSample("FTomFlam 3 Bleed", ftomFlamDestination + "ftomFlam_3_bleed.wav", 69 + 12, curveFor3[2], curveFor3[3] - 1, ftomRelease, 1.1, "TomsBleed");

        double hhRelease = 0.12;
        string tambDestination = dryDestination + "tambourine/";
        addSample("Tambourine 1 OH", tambDestination + "tambourine_1_OH.wav", 71 + 12, curveFor3[0], curveFor3[1] - 1, hhRelease, 0.5, "CymbalsOH");
        addSample("Tambourine 2 OH", tambDestination + "tambourine_2_OH.wav", 71 + 12, curveFor3[1], curveFor3[2] - 1, hhRelease, 0.9, "CymbalsOH");
        addSample("Tambourine 3 OH", tambDestination + "tambourine_3_OH.wav", 71 + 12, curveFor3[2], curveFor3[3] - 1, hhRelease, 0.8, "CymbalsOH");
        addSample("Tambourine 1 Room", tambDestination + "tambourine_1_room.wav", 71 + 12, curveFor3[0], curveFor3[1] - 1, hhRelease, 0.5, "CymbalsRoom");
        addSample("Tambourine 2 Room", tambDestination + "tambourine_2_room.wav", 71 + 12, curveFor3[1], curveFor3[2] - 1, hhRelease, 0.9, "CymbalsRoom");
        addSample("Tambourine 3 Room", tambDestination + "tambourine_3_room.wav", 71 + 12, curveFor3[2], curveFor3[3] - 1, hhRelease, 0.8, "CymbalsRoom");
        addSample("Tambourine 1 Bleed", tambDestination + "tambourine_1_bleed.wav", 71 + 12, curveFor3[0], curveFor3[1] - 1, hhRelease, 0.5, "CymbalsBleed");
        addSample("Tambourine 2 Bleed", tambDestination + "tambourine_2_bleed.wav", 71 + 12, curveFor3[1], curveFor3[2] - 1, hhRelease, 0.9, "CymbalsBleed");
        addSample("Tambourine 3 Bleed", tambDestination + "tambourine_3_bleed.wav", 71 + 12, curveFor3[2], curveFor3[3] - 1, hhRelease, 0.8, "CymbalsBleed");

        double hhMaxLen = 1.0;
        string HHAllDestination = dryDestination + "HHAll/";
        string HHClosedDestination = HHAllDestination + "HHClosed/";
        addSample("HHClosed 1 Close", HHClosedDestination + "HHClosed_1_close.wav", 73 + 12, curveFor6[0], curveFor6[1] - 1, hhRelease, 0.9, "HHClose");
        addSample("HHClosed 2 Close", HHClosedDestination + "HHClosed_2_close.wav", 73 + 12, curveFor6[1], curveFor6[2] - 1, hhRelease, 0.9, "HHClose");
        addSample("HHClosed 3 Close", HHClosedDestination + "HHClosed_3_close.wav", 73 + 12, curveFor6[2], curveFor6[3] - 1, hhRelease, 1.0, "HHClose");
        addSample("HHClosed 4 Close", HHClosedDestination + "HHClosed_4_close.wav", 73 + 12, curveFor6[3], curveFor6[4] - 1, hhRelease, 1.3, "HHClose");
        addSample("HHClosed 5 Close", HHClosedDestination + "HHClosed_5_close.wav", 73 + 12, curveFor6[4], curveFor6[5] - 1, hhRelease, 1.0, "HHClose");
        addSample("HHClosed 6 Close", HHClosedDestination + "HHClosed_6_close.wav", 73 + 12, curveFor6[5], curveFor6[6] - 1, hhRelease, 1.0, "HHClose");
        addSample("HHClosed 1 OH", HHClosedDestination + "HHClosed_1_OH.wav", 73 + 12, curveFor6[0], curveFor6[1] - 1, hhRelease, 0.9, "CymbalsOH");
        addSample("HHClosed 2 OH", HHClosedDestination + "HHClosed_2_OH.wav", 73 + 12, curveFor6[1], curveFor6[2] - 1, hhRelease, 0.9, "CymbalsOH");
        addSample("HHClosed 3 OH", HHClosedDestination + "HHClosed_3_OH.wav", 73 + 12, curveFor6[2], curveFor6[3] - 1, hhRelease, 1.0, "CymbalsOH");
        addSample("HHClosed 4 OH", HHClosedDestination + "HHClosed_4_OH.wav", 73 + 12, curveFor6[3], curveFor6[4] - 1, hhRelease, 1.3, "CymbalsOH");
        addSample("HHClosed 5 OH", HHClosedDestination + "HHClosed_5_OH.wav", 73 + 12, curveFor6[4], curveFor6[5] - 1, hhRelease, 1.0, "CymbalsOH");
        addSample("HHClosed 6 OH", HHClosedDestination + "HHClosed_6_OH.wav", 73 + 12, curveFor6[5], curveFor6[6] - 1, hhRelease, 1.0, "CymbalsOH");
        addSample("HHClosed 1 Room", HHClosedDestination + "HHClosed_1_room.wav", 73 + 12, curveFor6[0], curveFor6[1] - 1, hhRelease, 0.9, "CymbalsRoom");
        addSample("HHClosed 2 Room", HHClosedDestination + "HHClosed_2_room.wav", 73 + 12, curveFor6[1], curveFor6[2] - 1, hhRelease, 0.9, "CymbalsRoom");
        addSample("HHClosed 3 Room", HHClosedDestination + "HHClosed_3_room.wav", 73 + 12, curveFor6[2], curveFor6[3] - 1, hhRelease, 1.0, "CymbalsRoom");
        addSample("HHClosed 4 Room", HHClosedDestination + "HHClosed_4_room.wav", 73 + 12, curveFor6[3], curveFor6[4] - 1, hhRelease, 1.3, "CymbalsRoom");
        addSample("HHClosed 5 Room", HHClosedDestination + "HHClosed_5_room.wav", 73 + 12, curveFor6[4], curveFor6[5] - 1, hhRelease, 1.0, "CymbalsRoom");
        addSample("HHClosed 6 Room", HHClosedDestination + "HHClosed_6_room.wav", 73 + 12, curveFor6[5], curveFor6[6] - 1, hhRelease, 1.0, "CymbalsRoom");
        addSample("HHClosed 1 Bleed", HHClosedDestination + "HHClosed_1_bleed.wav", 73 + 12, curveFor6[0], curveFor6[1] - 1, hhRelease, 0.9, "CymbalsBleed");
        addSample("HHClosed 2 Bleed", HHClosedDestination + "HHClosed_2_bleed.wav", 73 + 12, curveFor6[1], curveFor6[2] - 1, hhRelease, 0.9, "CymbalsBleed");
        addSample("HHClosed 3 Bleed", HHClosedDestination + "HHClosed_3_bleed.wav", 73 + 12, curveFor6[2], curveFor6[3] - 1, hhRelease, 1.0, "CymbalsBleed");
        addSample("HHClosed 4 Bleed", HHClosedDestination + "HHClosed_4_bleed.wav", 73 + 12, curveFor6[3], curveFor6[4] - 1, hhRelease, 1.3, "CymbalsBleed");
        addSample("HHClosed 5 Bleed", HHClosedDestination + "HHClosed_5_bleed.wav", 73 + 12, curveFor6[4], curveFor6[5] - 1, hhRelease, 1.0, "CymbalsBleed");
        addSample("HHClosed 6 Bleed", HHClosedDestination + "HHClosed_6_bleed.wav", 73 + 12, curveFor6[5], curveFor6[6] - 1, hhRelease, 1.0, "CymbalsBleed");

        double hhHalfMaxLen = 1.4;
        string HHHalfDestination = HHAllDestination + "HHHalf/";
        addSample("HHHalf 1 Close", HHHalfDestination + "HHHalf_1_close.wav", 74 + 12, curveFor4[0], curveFor4[1] - 1, hhRelease, hhHalfMaxLen, "HHClose");
        addSample("HHHalf 2 Close", HHHalfDestination + "HHHalf_2_close.wav", 74 + 12, curveFor4[1], curveFor4[2] - 1, hhRelease, hhHalfMaxLen, "HHClose");
        addSample("HHHalf 3 Close", HHHalfDestination + "HHHalf_3_close.wav", 74 + 12, curveFor4[2], curveFor4[3] - 1, hhRelease, hhHalfMaxLen, "HHClose");
        addSample("HHHalf 4 Close", HHHalfDestination + "HHHalf_4_close.wav", 74 + 12, curveFor4[3], curveFor4[4] - 1, hhRelease, hhHalfMaxLen, "HHClose");
        addSample("HHHalf 1 OH", HHHalfDestination + "HHHalf_1_OH.wav", 74 + 12, curveFor4[0], curveFor4[1] - 1, hhRelease, hhHalfMaxLen, "CymbalsOH");
        addSample("HHHalf 2 OH", HHHalfDestination + "HHHalf_2_OH.wav", 74 + 12, curveFor4[1], curveFor4[2] - 1, hhRelease, hhHalfMaxLen, "CymbalsOH");
        addSample("HHHalf 3 OH", HHHalfDestination + "HHHalf_3_OH.wav", 74 + 12, curveFor4[2], curveFor4[3] - 1, hhRelease, hhHalfMaxLen, "CymbalsOH");
        addSample("HHHalf 4 OH", HHHalfDestination + "HHHalf_4_OH.wav", 74 + 12, curveFor4[3], curveFor4[4] - 1, hhRelease, hhHalfMaxLen, "CymbalsOH");
        addSample("HHHalf 1 Room", HHHalfDestination + "HHHalf_1_room.wav", 74 + 12, curveFor4[0], curveFor4[1] - 1, hhRelease, hhHalfMaxLen, "CymbalsRoom");
        addSample("HHHalf 2 Room", HHHalfDestination + "HHHalf_2_room.wav", 74 + 12, curveFor4[1], curveFor4[2] - 1, hhRelease, hhHalfMaxLen, "CymbalsRoom");
        addSample("HHHalf 3 Room", HHHalfDestination + "HHHalf_3_room.wav", 74 + 12, curveFor4[2], curveFor4[3] - 1, hhRelease, hhHalfMaxLen, "CymbalsRoom");
        addSample("HHHalf 4 Room", HHHalfDestination + "HHHalf_4_room.wav", 74 + 12, curveFor4[3], curveFor4[4] - 1, hhRelease, hhHalfMaxLen, "CymbalsRoom");
        addSample("HHHalf 1 Bleed", HHHalfDestination + "HHHalf_1_bleed.wav", 74 + 12, curveFor4[0], curveFor4[1] - 1, hhRelease, hhHalfMaxLen, "CymbalsBleed");
        addSample("HHHalf 2 Bleed", HHHalfDestination + "HHHalf_2_bleed.wav", 74 + 12, curveFor4[1], curveFor4[2] - 1, hhRelease, hhHalfMaxLen, "CymbalsBleed");
        addSample("HHHalf 3 Bleed", HHHalfDestination + "HHHalf_3_bleed.wav", 74 + 12, curveFor4[2], curveFor4[3] - 1, hhRelease, hhHalfMaxLen, "CymbalsBleed");
        addSample("HHHalf 4 Bleed", HHHalfDestination + "HHHalf_4_bleed.wav", 74 + 12, curveFor4[3], curveFor4[4] - 1, hhRelease, hhHalfMaxLen, "CymbalsBleed");

        double hhOpenMaxLen = 5.0;
        string HHOpenDestination = HHAllDestination + "HHOpen/";
        addSample("HHOpen 1 Close", HHOpenDestination + "HHOpen_1_close.wav", 75 + 12, curveFor5[0], curveFor5[1] - 1, hhRelease, 2.0, "HHClose");
        addSample("HHOpen 2 Close", HHOpenDestination + "HHOpen_2_close.wav", 75 + 12, curveFor5[1], curveFor5[2] - 1, hhRelease, 3.2, "HHClose");
        addSample("HHOpen 3 Close", HHOpenDestination + "HHOpen_3_close.wav", 75 + 12, curveFor5[2], curveFor5[3] - 1, hhRelease, 3.0, "HHClose");
        addSample("HHOpen 4 Close", HHOpenDestination + "HHOpen_4_close.wav", 75 + 12, curveFor5[3], curveFor5[4] - 1, hhRelease, 4.2, "HHClose");
        addSample("HHOpen 5 Close", HHOpenDestination + "HHOpen_5_close.wav", 75 + 12, curveFor5[4], curveFor5[5] - 1, hhRelease, 4.8, "HHClose");
        addSample("HHOpen 1 OH", HHOpenDestination + "HHOpen_1_OH.wav", 75 + 12, curveFor5[0], curveFor5[1] - 1, hhRelease, 2.0, "CymbalsOH");
        addSample("HHOpen 2 OH", HHOpenDestination + "HHOpen_2_OH.wav", 75 + 12, curveFor5[1], curveFor5[2] - 1, hhRelease, 3.2, "CymbalsOH");
        addSample("HHOpen 3 OH", HHOpenDestination + "HHOpen_3_OH.wav", 75 + 12, curveFor5[2], curveFor5[3] - 1, hhRelease, 3.0, "CymbalsOH");
        addSample("HHOpen 4 OH", HHOpenDestination + "HHOpen_4_OH.wav", 75 + 12, curveFor5[3], curveFor5[4] - 1, hhRelease, 4.2, "CymbalsOH");
        addSample("HHOpen 5 OH", HHOpenDestination + "HHOpen_5_OH.wav", 75 + 12, curveFor5[4], curveFor5[5] - 1, hhRelease, 4.8, "CymbalsOH");
        addSample("HHOpen 1 Room", HHOpenDestination + "HHOpen_1_room.wav", 75 + 12, curveFor5[0], curveFor5[1] - 1, hhRelease, 2.0, "CymbalsRoom");
        addSample("HHOpen 2 Room", HHOpenDestination + "HHOpen_2_room.wav", 75 + 12, curveFor5[1], curveFor5[2] - 1, hhRelease, 3.2, "CymbalsRoom");
        addSample("HHOpen 3 Room", HHOpenDestination + "HHOpen_3_room.wav", 75 + 12, curveFor5[2], curveFor5[3] - 1, hhRelease, 3.0, "CymbalsRoom");
        addSample("HHOpen 4 Room", HHOpenDestination + "HHOpen_4_room.wav", 75 + 12, curveFor5[3], curveFor5[4] - 1, hhRelease, 4.2, "CymbalsRoom");
        addSample("HHOpen 5 Room", HHOpenDestination + "HHOpen_5_room.wav", 75 + 12, curveFor5[4], curveFor5[5] - 1, hhRelease, 4.8, "CymbalsRoom");
        addSample("HHOpen 1 Bleed", HHOpenDestination + "HHOpen_1_bleed.wav", 75 + 12, curveFor5[0], curveFor5[1] - 1, hhRelease, 2.0, "CymbalsBleed");
        addSample("HHOpen 2 Bleed", HHOpenDestination + "HHOpen_2_bleed.wav", 75 + 12, curveFor5[1], curveFor5[2] - 1, hhRelease, 3.2, "CymbalsBleed");
        addSample("HHOpen 3 Bleed", HHOpenDestination + "HHOpen_3_bleed.wav", 75 + 12, curveFor5[2], curveFor5[3] - 1, hhRelease, 3.0, "CymbalsBleed");
        addSample("HHOpen 4 Bleed", HHOpenDestination + "HHOpen_4_bleed.wav", 75 + 12, curveFor5[3], curveFor5[4] - 1, hhRelease, 4.2, "CymbalsBleed");
        addSample("HHOpen 5 Bleed", HHOpenDestination + "HHOpen_5_bleed.wav", 75 + 12, curveFor5[4], curveFor5[5] - 1, hhRelease, 4.8, "CymbalsBleed");
