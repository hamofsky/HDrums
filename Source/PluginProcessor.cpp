...
void HDrumsAudioProcessor::loadSamples(int samplePackID)
{
    ...
    else if (samplePackID == 2) // Acoustic Drum Kit
    {
        ...
        addSample("Ride Smooth", destinationP + "Ride Smooth.wav", defaultMidiNotes[18], 1, curveFor6[0] - 1, 0.5, 8.0, "Close");
        addSample("Ride Hard", destinationP + "Ride Hard.wav", defaultMidiNotes[20], curveFor6[0], 127, 5.0, 8.0, "Close");
        string GGDdestination = destinationP + "GGD/";
        addSample("HH open", GGDdestination + "HH open.wav", defaultMidiNotes[16], 1, 127, 0.12, 6.5, "Close");
        addSample("HH closed", GGDdestination + "HH closed.wav", defaultMidiNotes[14], 1, 127, 0.1, 2.0, "Close");
        ...
        addSample("FT Close 1_1", FTCloseDestination + "FT Close 1_1.wav", defaultMidiNotes[11], 1, 127, 0.7, 1.5, "Close");
        string FTOHDestination = destinationP + "Konrad1/FT/OH/";
        addSample("FT OH 1_1", FTOHDestination + "FT OH 1_1.wav", defaultMidiNotes[11], 1, 127, 0.7, 1.5, "OH");
    ...
    else if (samplePackID == 3) // Dry Drum Kit
    {
        ...
        addSample("Dry SnareFlam 1 Top", snareFlamDestination + "snareFlam_1_top.wav", defaultMidiNotes[3], curveFor4[0], curveFor4[1] - 1, snareRelease, 1.8, "SnareTop");
        addSample("Dry SnareFlam 2 Top", snareFlamDestination + "snareFlam_2_top.wav", defaultMidiNotes[3], curveFor4[1], curveFor4[2] - 1, snareRelease, 1.3, "SnareTop");
        addSample("Dry SnareFlam 3 Top", snareFlamDestination + "snareFlam_3_top.wav", defaultMidiNotes[3], curveFor4[2], curveFor4[3] - 1, snareRelease, 1.3, "SnareTop");
        addSample("Dry SnareFlam 4 Top", snareFlamDestination + "snareFlam_4_top.wav", defaultMidiNotes[3], curveFor4[3], curveFor4[4] - 1, snareRelease, 1.4, "SnareTop");
        addSample("Dry SnareFlam 1 Bot", snareFlamDestination + "snareFlam_1_bot.wav", defaultMidiNotes[3], curveFor4[0], curveFor4[1] - 1, snareRelease, 1.8, "SnareBot");
        addSample("Dry SnareFlam 2 Bot", snareFlamDestination + "snareFlam_2_bot.wav", defaultMidiNotes[3], curveFor4[1], curveFor4[2] - 1, snareRelease, 1.3, "SnareBot");
        addSample("Dry SnareFlam 3 Bot", snareFlamDestination + "snareFlam_3_bot.wav", defaultMidiNotes[3], curveFor4[2], curveFor4[3] - 1, snareRelease, 1.3, "SnareBot");
        addSample("Dry SnareFlam 4 Bot", snareFlamDestination + "snareFlam_4_bot.wav", defaultMidiNotes[3], curveFor4[3], curveFor4[4] - 1, snareRelease, 1.4, "SnareBot");
        addSample("Dry SnareFlam 1 OH", snareFlamDestination + "snareFlam_1_OH.wav", defaultMidiNotes[3], curveFor4[0], curveFor4[1] - 1, snareRelease, 1.8, "SnareOH");
        addSample("Dry SnareFlam 2 OH", snareFlamDestination + "snareFlam_2_OH.wav", defaultMidiNotes[3], curveFor4[1], curveFor4[2] - 1, snareRelease, 1.3, "SnareOH");
        addSample("Dry SnareFlam 3 OH", snareFlamDestination + "snareFlam_3_OH.wav", defaultMidiNotes[3], curveFor4[2], curveFor4[3] - 1, snareRelease, 1.3, "SnareOH");
        addSample("Dry SnareFlam 4 OH", snareFlamDestination + "snareFlam_4_OH.wav", defaultMidiNotes[3], curveFor4[3], curveFor4[4] - 1, snareRelease, 1.4, "SnareOH");
        addSample("Dry SnareFlam 1 Room", snareFlamDestination + "snareFlam_1_room.wav", defaultMidiNotes[3], curveFor4[0], curveFor4[1] - 1, snareRelease, 1.8, "SnareRoom");
        addSample("Dry SnareFlam 2 Room", snareFlamDestination + "snareFlam_2_room.wav", defaultMidiNotes[3], curveFor4[1], curveFor4[2] - 1, snareRelease, 1.3, "SnareRoom");
        addSample("Dry SnareFlam 3 Room", snareFlamDestination + "snareFlam_3_room.wav", defaultMidiNotes[3], curveFor4[2], curveFor4[3] - 1, snareRelease, 1.3, "SnareRoom");
        addSample("Dry SnareFlam 4 Room", snareFlamDestination + "snareFlam_4_room.wav", defaultMidiNotes[3], curveFor4[3], curveFor4[4] - 1, snareRelease, 1.4, "SnareRoom");
        addSample("Dry SnareFlam 1 Bleed", snareFlamDestination + "snareFlam_1_bleed.wav", defaultMidiNotes[3], curveFor4[0], curveFor4[1] - 1, snareRelease, 1.8, "SnareBleed");
        addSample("Dry SnareFlam 2 Bleed", snareFlamDestination + "snareFlam_2_bleed.wav", defaultMidiNotes[3], curveFor4[1], curveFor4[2] - 1, snareRelease, 1.3, "SnareBleed");
        addSample("Dry SnareFlam 3 Bleed", snareFlamDestination + "snareFlam_3_bleed.wav", defaultMidiNotes[3], curveFor4[2], curveFor4[3] - 1, snareRelease, 1.3, "SnareBleed");
        addSample("Dry SnareFlam 4 Bleed", snareFlamDestination + "snareFlam_4_bleed.wav", defaultMidiNotes[3], curveFor4[3], curveFor4[4] - 1, snareRelease, 1.4, "SnareBleed");

        double snareMaxLen2 = 1.1;
        string snareRoundDestination = snareAllDestination + "snareRound/";
        addSample("Dry SnareRound 1 Top", snareRoundDestination + "snareRound_1_top.wav", defaultMidiNotes[4], curveFor3[0], curveFor3[1] - 1, snareRelease, snareMaxLen2, "SnareTop");
        addSample("Dry SnareRound 2 Top", snareRoundDestination + "snareRound_2_top.wav", defaultMidiNotes[4], curveFor3[1], curveFor3[2] - 1, snareRelease, snareMaxLen2, "SnareTop");
        addSample("Dry SnareRound 3 Top", snareRoundDestination + "snareRound_3_top.wav", defaultMidiNotes[4], curveFor3[2], curveFor3[3] - 1, snareRelease, snareMaxLen2, "SnareTop");
        addSample("Dry SnareRound 1 Bot", snareRoundDestination + "snareRound_1_bot.wav", defaultMidiNotes[4], curveFor3[0], curveFor3[1] - 1, snareRelease, snareMaxLen2, "SnareBot");
        addSample("Dry SnareRound 2 Bot", snareRoundDestination + "snareRound_2_bot.wav", defaultMidiNotes[4], curveFor3[1], curveFor3[2] - 1, snareRelease, snareMaxLen2, "SnareBot");
        addSample("Dry SnareRound 3 Bot", snareRoundDestination + "snareRound_3_bot.wav", defaultMidiNotes[4], curveFor3[2], curveFor3[3] - 1, snareRelease, snareMaxLen2, "SnareBot");
        addSample("Dry SnareRound 1 OH", snareRoundDestination + "snareRound_1_OH.wav", defaultMidiNotes[4], curveFor3[0], curveFor3[1] - 1, snareRelease, snareMaxLen2, "SnareOH");
        addSample("Dry SnareRound 2 OH", snareRoundDestination + "snareRound_2_OH.wav", defaultMidiNotes[4], curveFor3[1], curveFor3[2] - 1, snareRelease, snareMaxLen2, "SnareOH");
        addSample("Dry SnareRound 3 OH", snareRoundDestination + "snareRound_3_OH.wav", defaultMidiNotes[4], curveFor3[2], curveFor3[3] - 1, snareRelease, snareMaxLen2, "SnareOH");
        addSample("Dry SnareRound 1 Room", snareRoundDestination + "snareRound_1_room.wav", defaultMidiNotes[4], curveFor3[0], curveFor3[1] - 1, snareRelease, snareMaxLen2, "SnareRoom");
        addSample("Dry SnareRound 2 Room", snareRoundDestination + "snareRound_2_room.wav", defaultMidiNotes[4], curveFor3[1], curveFor3[2] - 1, snareRelease, snareMaxLen2, "SnareRoom");
        addSample("Dry SnareRound 3 Room", snareRoundDestination + "snareRound_3_room.wav", defaultMidiNotes[4], curveFor3[2], curveFor3[3] - 1, snareRelease, snareMaxLen2, "SnareRoom");
        addSample("Dry SnareRound 1 Bleed", snareRoundDestination + "snareRound_1_bleed.wav", defaultMidiNotes[4], curveFor3[0], curveFor3[1] - 1, snareRelease, snareMaxLen2, "SnareBleed");
        addSample("Dry SnareRound 2 Bleed", snareRoundDestination + "snareRound_2_bleed.wav", defaultMidiNotes[4], curveFor3[1], curveFor3[2] - 1, snareRelease, snareMaxLen2, "SnareBleed");
        addSample("Dry SnareRound 3 Bleed", snareRoundDestination + "snareRound_3_bleed.wav", defaultMidiNotes[4], curveFor3[2], curveFor3[3] - 1, snareRelease, snareMaxLen2, "SnareBleed");

        string snareWirelessDestination = snareAllDestination + "snareWireless/";
        addSample("Dry SnareWireless 1 Top", snareWirelessDestination + "snareWireless_1_top.wav", defaultMidiNotes[5], curveFor4[0], curveFor4[1] - 1, snareRelease, 0.75, "SnareTop");
        addSample("Dry SnareWireless 2 Top", snareWirelessDestination + "snareWireless_2_top.wav", defaultMidiNotes[5], curveFor4[1], curveFor4[2] - 1, snareRelease, 0.75, "SnareTop");
        addSample("Dry SnareWireless 3 Top", snareWirelessDestination + "snareWireless_3_top.wav", defaultMidiNotes[5], curveFor4[2], curveFor4[3] - 1, snareRelease, 0.99, "SnareTop");
        addSample("Dry SnareWireless 4 Top", snareWirelessDestination + "snareWireless_4_top.wav", defaultMidiNotes[5], curveFor4[3], curveFor4[4] - 1, snareRelease, 0.99, "SnareTop");
        addSample("Dry SnareWireless 1 Bot", snareWirelessDestination + "snareWireless_1_bot.wav", defaultMidiNotes[5], curveFor4[0], curveFor4[1] - 1, snareRelease, 0.75, "SnareBot");
        addSample("Dry SnareWireless 2 Bot", snareWirelessDestination + "snareWireless_2_bot.wav", defaultMidiNotes[5], curveFor4[1], curveFor4[2] - 1, snareRelease, 0.75, "SnareBot");
        addSample("Dry SnareWireless 3 Bot", snareWirelessDestination + "snareWireless_3_bot.wav", defaultMidiNotes[5], curveFor4[2], curveFor4[3] - 1, snareRelease, 0.99, "SnareBot");
        addSample("Dry SnareWireless 4 Bot", snareWirelessDestination + "snareWireless_4_bot.wav", defaultMidiNotes[5], curveFor4[3], curveFor4[4] - 1, snareRelease, 0.99, "SnareBot");
        addSample("Dry SnareWireless 1 OH", snareWirelessDestination + "snareWireless_1_OH.wav", defaultMidiNotes[5], curveFor4[0], curveFor4[1] - 1, snareRelease, 0.75, "SnareOH");
        addSample("Dry SnareWireless 2 OH", snareWirelessDestination + "snareWireless_2_OH.wav", defaultMidiNotes[5], curveFor4[1], curveFor4[2] - 1, snareRelease, 0.75, "SnareOH");
        addSample("Dry SnareWireless 3 OH", snareWirelessDestination + "snareWireless_3_OH.wav", defaultMidiNotes[5], curveFor4[2], curveFor4[3] - 1, snareRelease, 0.99, "SnareOH");
        addSample("Dry SnareWireless 4 OH", snareWirelessDestination + "snareWireless_4_OH.wav", defaultMidiNotes[5], curveFor4[3], curveFor4[4] - 1, snareRelease, 0.99, "SnareOH");
        addSample("Dry SnareWireless 1 Room", snareWirelessDestination + "snareWireless_1_room.wav", defaultMidiNotes[5], curveFor4[0], curveFor4[1] - 1, snareRelease, 0.75, "SnareRoom");
        addSample("Dry SnareWireless 2 Room", snareWirelessDestination + "snareWireless_2_room.wav", defaultMidiNotes[5], curveFor4[1], curveFor4[2] - 1, snareRelease, 0.75, "SnareRoom");
        addSample("Dry SnareWireless 3 Room", snareWirelessDestination + "snareWireless_3_room.wav", defaultMidiNotes[5], curveFor4[2], curveFor4[3] - 1, snareRelease, 0.99, "SnareRoom");
        addSample("Dry SnareWireless 4 Room", snareWirelessDestination + "snareWireless_4_room.wav", defaultMidiNotes[5], curveFor4[3], curveFor4[4] - 1, snareRelease, 0.99, "SnareRoom");
        addSample("Dry SnareWireless 1 Bleed", snareWirelessDestination + "snareWireless_1_bleed.wav", defaultMidiNotes[5], curveFor4[0], curveFor4[1] - 1, snareRelease, 0.75, "SnareBleed");
        addSample("Dry SnareWireless 2 Bleed", snareWirelessDestination + "snareWireless_2_bleed.wav", defaultMidiNotes[5], curveFor4[1], curveFor4[2] - 1, snareRelease, 0.75, "SnareBleed");
        addSample("Dry SnareWireless 3 Bleed", snareWirelessDestination + "snareWireless_3_bleed.wav", defaultMidiNotes[5], curveFor4[2], curveFor4[3] - 1, snareRelease, 0.99, "SnareBleed");
        addSample("Dry SnareWireless 4 Bleed", snareWirelessDestination + "snareWireless_4_bleed.wav", defaultMidiNotes[5], curveFor4[3], curveFor4[4] - 1, snareRelease, 0.99, "SnareBleed");

        string snareWirelessRoundDestination = snareAllDestination + "snareWirelessRound/";
        addSample("Dry SnareWirelessRound 1 Top", snareWirelessRoundDestination + "snareWirelessRound_1_top.wav", defaultMidiNotes[6], curveFor3[0], curveFor3[1] - 1, snareRelease, 0.5, "SnareTop");
        addSample("Dry SnareWirelessRound 2 Top", snareWirelessRoundDestination + "snareWirelessRound_2_top.wav", defaultMidiNotes[6], curveFor3[1], curveFor3[2] - 1, snareRelease, 0.5, "SnareTop");
        addSample("Dry SnareWirelessRound 3 Top", snareWirelessRoundDestination + "snareWirelessRound_3_top.wav", defaultMidiNotes[6], curveFor3[2], curveFor3[3] - 1, snareRelease, 0.5, "SnareTop");
        addSample("Dry SnareWirelessRound 1 Bot", snareWirelessRoundDestination + "snareWirelessRound_1_bot.wav", defaultMidiNotes[6], curveFor3[0], curveFor3[1] - 1, snareRelease, 0.5, "SnareBot");
        addSample("Dry SnareWirelessRound 2 Bot", snareWirelessRoundDestination + "snareWirelessRound_2_bot.wav", defaultMidiNotes[6], curveFor3[1], curveFor3[2] - 1, snareRelease, 0.5, "SnareBot");
        addSample("Dry SnareWirelessRound 3 Bot", snareWirelessRoundDestination + "snareWirelessRound_3_bot.wav", defaultMidiNotes[6], curveFor3[2], curveFor3[3] - 1, snareRelease, 0.5, "SnareBot");
        addSample("Dry SnareWirelessRound 1 OH", snareWirelessRoundDestination + "snareWirelessRound_1_OH.wav", defaultMidiNotes[6], curveFor3[0], curveFor3[1] - 1, snareRelease, 0.5, "SnareOH");
        addSample("Dry SnareWirelessRound 2 OH", snareWirelessRoundDestination + "snareWirelessRound_2_OH.wav", defaultMidiNotes[6], curveFor3[1], curveFor3[2] - 1, snareRelease, 0.5, "SnareOH");
        addSample("Dry SnareWirelessRound 3 OH", snareWirelessRoundDestination + "snareWirelessRound_3_OH.wav", defaultMidiNotes[6], curveFor3[2], curveFor3[3] - 1, snareRelease, 0.5, "SnareOH");
        addSample("Dry SnareWirelessRound 1 Room", snareWirelessRoundDestination + "snareWirelessRound_1_room.wav", defaultMidiNotes[6], curveFor3[0], curveFor3[1] - 1, snareRelease, 0.5, "SnareRoom");
        addSample("Dry SnareWirelessRound 2 Room", snareWirelessRoundDestination + "snareWirelessRound_2_room.wav", defaultMidiNotes[6], curveFor3[1], curveFor3[2] - 1, snareRelease, 0.5, "SnareRoom");
        addSample("Dry SnareWirelessRound 3 Room", snareWirelessRoundDestination + "snareWirelessRound_3_room.wav", defaultMidiNotes[6], curveFor3[2], curveFor3[3] - 1, snareRelease, 0.5, "SnareRoom");
        addSample("Dry SnareWirelessRound 1 Bleed", snareWirelessRoundDestination + "snareWirelessRound_1_bleed.wav", defaultMidiNotes[6], curveFor3[0], curveFor3[1] - 1, snareRelease, 0.5, "SnareBleed");
        addSample("Dry SnareWirelessRound 2 Bleed", snareWirelessRoundDestination + "snareWirelessRound_2_bleed.wav", defaultMidiNotes[6], curveFor3[1], curveFor3[2] - 1, snareRelease, 0.5, "SnareBleed");
        addSample("Dry SnareWirelessRound 3 Bleed", snareWirelessRoundDestination + "snareWirelessRound_3_bleed.wav", defaultMidiNotes[6], curveFor3[2], curveFor3[3] - 1, snareRelease, 0.5, "SnareBleed");
        ...
        addSample("Dry Tom 1 Close", tomDestination + "tom_1_close.wav", defaultMidiNotes[9], curveFor4[0], curveFor4[1] - 1, tomRelease, 0.7, "TomClose");
        addSample("Dry Tom 2 Close", tomDestination + "tom_2_close.wav", defaultMidiNotes[9], curveFor4[1], curveFor4[2] - 1, tomRelease, 0.7, "TomClose");
        addSample("Dry Tom 3 Close", tomDestination + "tom_3_close.wav", defaultMidiNotes[9], curveFor4[2], curveFor4[3] - 1, tomRelease, 0.9, "TomClose");
        addSample("Dry Tom 4 Close", tomDestination + "tom_4_close.wav", defaultMidiNotes[9], curveFor4[3], curveFor4[4] - 1, tomRelease, 1.0, "TomClose");
        addSample("Dry Tom 1 OH", tomDestination + "tom_1_OH.wav", defaultMidiNotes[9], curveFor4[0], curveFor4[1] - 1, tomRelease, 0.7, "TomsOH");
        addSample("Dry Tom 2 OH", tomDestination + "tom_2_OH.wav", defaultMidiNotes[9], curveFor4[1], curveFor4[2] - 1, tomRelease, 0.7, "TomsOH");
        addSample("Dry Tom 3 OH", tomDestination + "tom_3_OH.wav", defaultMidiNotes[9], curveFor4[2], curveFor4[3] - 1, tomRelease, 0.9, "TomsOH");
        addSample("Dry Tom 4 OH", tomDestination + "tom_4_OH.wav", defaultMidiNotes[9], curveFor4[3], curveFor4[4] - 1, tomRelease, 1.0, "TomsOH");
        addSample("Dry Tom 1 Room", tomDestination + "tom_1_room.wav", defaultMidiNotes[9], curveFor4[0], curveFor4[1] - 1, tomRelease, 0.7, "TomsRoom");
        addSample("Dry Tom 2 Room", tomDestination + "tom_2_room.wav", defaultMidiNotes[9], curveFor4[1], curveFor4[2] - 1, tomRelease, 0.7, "TomsRoom");
        addSample("Dry Tom 3 Room", tomDestination + "tom_3_room.wav", defaultMidiNotes[9], curveFor4[2], curveFor4[3] - 1, tomRelease, 0.9, "TomsRoom");
        addSample("Dry Tom 4 Room", tomDestination + "tom_4_room.wav", defaultMidiNotes[9], curveFor4[3], curveFor4[4] - 1, tomRelease, 1.0, "TomsRoom");
        addSample("Dry Tom 1 Bleed", tomDestination + "tom_1_bleed.wav", defaultMidiNotes[9], curveFor4[0], curveFor4[1] - 1, tomRelease, 0.7, "TomsBleed");
        addSample("Dry Tom 2 Bleed", tomDestination + "tom_2_bleed.wav", defaultMidiNotes[9], curveFor4[1], curveFor4[2] - 1, tomRelease, 0.7, "TomsBleed");
        addSample("Dry Tom 3 Bleed", tomDestination + "tom_3_bleed.wav", defaultMidiNotes[9], curveFor4[2], curveFor4[3] - 1, tomRelease, 0.9, "TomsBleed");
        addSample("Dry Tom 4 Bleed", tomDestination + "tom_4_bleed.wav", defaultMidiNotes[9], curveFor4[3], curveFor4[4] - 1, tomRelease, 1.0, "TomsBleed");

        string tomFlamDestination = tomAllDestination + "tomFlam/";
        addSample("Dry TomFlam 1 Close", tomFlamDestination + "tomFlam_1_close.wav", defaultMidiNotes[10], curveFor3[0], curveFor3[1] - 1, tomRelease, 0.9, "TomClose");
        addSample("Dry TomFlam 2 Close", tomFlamDestination + "tomFlam_2_close.wav", defaultMidiNotes[10], curveFor3[1], curveFor3[2] - 1, tomRelease, 1.0, "TomClose");
        addSample("Dry TomFlam 3 Close", tomFlamDestination + "tomFlam_3_close.wav", defaultMidiNotes[10], curveFor3[2], curveFor3[3] - 1, tomRelease, 1.1, "TomClose");
        addSample("Dry TomFlam 1 OH", tomFlamDestination + "tomFlam_1_OH.wav", defaultMidiNotes[10], curveFor3[0], curveFor3[1] - 1, tomRelease, 0.9, "TomsOH");
        addSample("Dry TomFlam 2 OH", tomFlamDestination + "tomFlam_2_OH.wav", defaultMidiNotes[10], curveFor3[1], curveFor3[2] - 1, tomRelease, 1.0, "TomsOH");
        addSample("Dry TomFlam 3 OH", tomFlamDestination + "tomFlam_3_OH.wav", defaultMidiNotes[10], curveFor3[2], curveFor3[3] - 1, tomRelease, 1.1, "TomsOH");
        addSample("Dry TomFlam 1 Room", tomFlamDestination + "tomFlam_1_room.wav", defaultMidiNotes[10], curveFor3[0], curveFor3[1] - 1, tomRelease, 0.9, "TomsRoom");
        addSample("Dry TomFlam 2 Room", tomFlamDestination + "tomFlam_2_room.wav", defaultMidiNotes[10], curveFor3[1], curveFor3[2] - 1, tomRelease, 1.0, "TomsRoom");
        addSample("Dry TomFlam 3 Room", tomFlamDestination + "tomFlam_3_room.wav", defaultMidiNotes[10], curveFor3[2], curveFor3[3] - 1, tomRelease, 1.1, "TomsRoom");
        addSample("Dry TomFlam 1 Bleed", tomFlamDestination + "tomFlam_1_bleed.wav", defaultMidiNotes[10], curveFor3[0], curveFor3[1] - 1, tomRelease, 0.9, "TomsBleed");
        addSample("Dry TomFlam 2 Bleed", tomFlamDestination + "tomFlam_2_bleed.wav", defaultMidiNotes[10], curveFor3[1], curveFor3[2] - 1, tomRelease, 1.0, "TomsBleed");
        addSample("Dry TomFlam 3 Bleed", tomFlamDestination + "tomFlam_3_bleed.wav", defaultMidiNotes[10], curveFor3[2], curveFor3[3] - 1, tomRelease, 1.1, "TomsBleed");
        ...
        addSample("Dry FTom 1 Close", ftomDestination + "ftom_1_close.wav", defaultMidiNotes[11], curveFor4[0], curveFor4[1] - 1, ftomRelease, 0.4, "FTomClose");
        addSample("Dry FTom 2 Close", ftomDestination + "ftom_2_close.wav", defaultMidiNotes[11], curveFor4[1], curveFor4[2] - 1, ftomRelease, 0.9, "FTomClose");
        addSample("Dry FTom 3 Close", ftomDestination + "ftom_3_close.wav", defaultMidiNotes[11], curveFor4[2], curveFor4[3] - 1, ftomRelease, 0.9, "FTomClose");
        addSample("Dry FTom 4 Close", ftomDestination + "ftom_4_close.wav", defaultMidiNotes[11], curveFor4[3], curveFor4[4] - 1, ftomRelease, 1.0, "FTomClose");
        addSample("Dry FTom 1 OH", ftomDestination + "ftom_1_OH.wav", defaultMidiNotes[11], curveFor4[0], curveFor4[1] - 1, ftomRelease, 0.4, "TomsOH");
        addSample("Dry FTom 2 OH", ftomDestination + "ftom_2_OH.wav", defaultMidiNotes[11], curveFor4[1], curveFor4[2] - 1, ftomRelease, 0.9, "TomsOH");
        addSample("Dry FTom 3 OH", ftomDestination + "ftom_3_OH.wav", defaultMidiNotes[11], curveFor4[2], curveFor4[3] - 1, ftomRelease, 0.9, "TomsOH");
        addSample("Dry FTom 4 OH", ftomDestination + "ftom_4_OH.wav", defaultMidiNotes[11], curveFor4[3], curveFor4[4] - 1, ftomRelease, 1.0, "TomsOH");
        addSample("Dry FTom 1 Room", ftomDestination + "ftom_1_room.wav", defaultMidiNotes[11], curveFor4[0], curveFor4[1] - 1, ftomRelease, 0.4, "TomsRoom");
        addSample("Dry FTom 2 Room", ftomDestination + "ftom_2_room.wav", defaultMidiNotes[11], curveFor4[1], curveFor4[2] - 1, ftomRelease, 0.9, "TomsRoom");
        addSample("Dry FTom 3 Room", ftomDestination + "ftom_3_room.wav", defaultMidiNotes[11], curveFor4[2], curveFor4[3] - 1, ftomRelease, 0.9, "TomsRoom");
        addSample("Dry FTom 4 Room", ftomDestination + "ftom_4_room.wav", defaultMidiNotes[11], curveFor4[3], curveFor4[4] - 1, ftomRelease, 1.0, "TomsRoom");
        addSample("Dry FTom 1 Bleed", ftomDestination + "ftom_1_bleed.wav", defaultMidiNotes[11], curveFor4[0], curveFor4[1] - 1, tomRelease, 0.4, "TomsBleed");
        addSample("Dry FTom 2 Bleed", ftomDestination + "ftom_2_bleed.wav", defaultMidiNotes[11], curveFor4[1], curveFor4[2] - 1, tomRelease, 0.9, "TomsBleed");
        addSample("Dry FTom 3 Bleed", ftomDestination + "ftom_3_bleed.wav", defaultMidiNotes[11], curveFor4[2], curveFor4[3] - 1, tomRelease, 0.9, "TomsBleed");
        addSample("Dry FTom 4 Bleed", ftomDestination + "ftom_4_bleed.wav", defaultMidiNotes[11], curveFor4[3], curveFor4[4] - 1, tomRelease, 1.0, "TomsBleed");

        string ftomFlamDestination = ftomAllDestination + "ftomFlam/";
        addSample("Dry FTomFlam 1 Close", ftomFlamDestination + "ftomFlam_1_close.wav", defaultMidiNotes[12], curveFor3[0], curveFor3[1] - 1, ftomRelease, 0.9, "FTomClose");
        addSample("Dry FTomFlam 2 Close", ftomFlamDestination + "ftomFlam_2_close.wav", defaultMidiNotes[12], curveFor3[1], curveFor3[2] - 1, ftomRelease, 1.0, "FTomClose");
        addSample("Dry FTomFlam 3 Close", ftomFlamDestination + "ftomFlam_3_close.wav", defaultMidiNotes[12], curveFor3[2], curveFor3[3] - 1, ftomRelease, 1.1, "FTomClose");
        addSample("Dry FTomFlam 1 OH", ftomFlamDestination + "ftomFlam_1_OH.wav", defaultMidiNotes[12], curveFor3[0], curveFor3[1] - 1, ftomRelease, 0.9, "TomsOH");
        addSample("Dry FTomFlam 2 OH", ftomFlamDestination + "ftomFlam_2_OH.wav", defaultMidiNotes[12], curveFor3[1], curveFor3[2] - 1, ftomRelease, 1.0, "TomsOH");
        addSample("Dry FTomFlam 3 OH", ftomFlamDestination + "ftomFlam_3_OH.wav", defaultMidiNotes[12], curveFor3[2], curveFor3[3] - 1, ftomRelease, 1.1, "TomsOH");
        addSample("Dry FTomFlam 1 Room", ftomFlamDestination + "ftomFlam_1_room.wav", defaultMidiNotes[12], curveFor3[0], curveFor3[1] - 1, ftomRelease, 0.9, "TomsRoom");
        addSample("Dry FTomFlam 2 Room", ftomFlamDestination + "ftomFlam_2_room.wav", defaultMidiNotes[12], curveFor3[1], curveFor3[2] - 1, ftomRelease, 1.0, "TomsRoom");
        addSample("Dry FTomFlam 3 Room", ftomFlamDestination + "ftomFlam_3_room.wav", defaultMidiNotes[12], curveFor3[2], curveFor3[3] - 1, ftomRelease, 1.1, "TomsRoom");
        addSample("Dry FTomFlam 1 Bleed", ftomFlamDestination + "ftomFlam_1_bleed.wav", defaultMidiNotes[12], curveFor3[0], curveFor3[1] - 1, ftomRelease, 0.9, "TomsBleed");
        addSample("Dry FTomFlam 2 Bleed", ftomFlamDestination + "ftomFlam_2_bleed.wav", defaultMidiNotes[12], curveFor3[1], curveFor3[2] - 1, ftomRelease, 1.0, "TomsBleed");
        addSample("Dry FTomFlam 3 Bleed", ftomFlamDestination + "ftomFlam_3_bleed.wav", defaultMidiNotes[12], curveFor3[2], curveFor3[3] - 1, ftomRelease, 1.1, "TomsBleed");

        double hhRelease = 0.12;
        double hhMaxLen = 1.0;
        string HHAllDestination = dryDestination + "HHAll/";
        string HHClosedDestination = HHAllDestination + "HHClosed/";
        addSample("Dry HHClosed 1 Close", HHClosedDestination + "HHClosed_1_close.wav", defaultMidiNotes[14], curveFor5[0], curveFor5[1] - 1, hhRelease, 0.9, "HHClose");
        addSample("Dry HHClosed 2 Close", HHClosedDestination + "HHClosed_2_close.wav", defaultMidiNotes[14], curveFor5[1], curveFor5[2] - 1, hhRelease, 0.9, "HHClose");
        addSample("Dry HHClosed 3 Close", HHClosedDestination + "HHClosed_3_close.wav", defaultMidiNotes[14], curveFor5[2], curveFor5[3] - 1, hhRelease, 1.0, "HHClose");
        addSample("Dry HHClosed 4 Close", HHClosedDestination + "HHClosed_4_close.wav", defaultMidiNotes[14], curveFor5[3], curveFor5[4] - 1, hhRelease, 1.3, "HHClose");
        addSample("Dry HHClosed 5 Close", HHClosedDestination + "HHClosed_5_close.wav", defaultMidiNotes[14], curveFor5[4], curveFor5[5] - 1, hhRelease, 1.0, "HHClose");
        addSample("Dry HHClosed 1 OH", HHClosedDestination + "HHClosed_1_OH.wav", defaultMidiNotes[14], curveFor5[0], curveFor5[1] - 1, hhRelease, 0.9, "CymbalsOH");
        addSample("Dry HHClosed 2 OH", HHClosedDestination + "HHClosed_2_OH.wav", defaultMidiNotes[14], curveFor5[1], curveFor5[2] - 1, hhRelease, 0.9, "CymbalsOH");
        addSample("Dry HHClosed 3 OH", HHClosedDestination + "HHClosed_3_OH.wav", defaultMidiNotes[14], curveFor5[2], curveFor5[3] - 1, hhRelease, 1.0, "CymbalsOH");
        addSample("Dry HHClosed 4 OH", HHClosedDestination + "HHClosed_4_OH.wav", defaultMidiNotes[14], curveFor5[3], curveFor5[4] - 1, hhRelease, 1.3, "CymbalsOH");
        addSample("Dry HHClosed 5 OH", HHClosedDestination + "HHClosed_5_OH.wav", defaultMidiNotes[14], curveFor5[4], curveFor5[5] - 1, hhRelease, 1.0, "CymbalsOH");
        addSample("Dry HHClosed 1 Room", HHClosedDestination + "HHClosed_1_room.wav", defaultMidiNotes[14], curveFor5[0], curveFor5[1] - 1, hhRelease, 0.9, "CymbalsRoom");
        addSample("Dry HHClosed 2 Room", HHClosedDestination + "HHClosed_2_room.wav", defaultMidiNotes[14], curveFor5[1], curveFor5[2] - 1, hhRelease, 0.9, "CymbalsRoom");
        addSample("Dry HHClosed 3 Room", HHClosedDestination + "HHClosed_3_room.wav", defaultMidiNotes[14], curveFor5[2], curveFor5[3] - 1, hhRelease, 1.0, "CymbalsRoom");
        addSample("Dry HHClosed 4 Room", HHClosedDestination + "HHClosed_4_room.wav", defaultMidiNotes[14], curveFor5[3], curveFor5[4] - 1, hhRelease, 1.3, "CymbalsRoom");
        addSample("Dry HHClosed 5 Room", HHClosedDestination + "HHClosed_5_room.wav", defaultMidiNotes[14], curveFor5[4], curveFor5[5] - 1, hhRelease, 1.0, "CymbalsRoom");
        addSample("Dry HHClosed 1 Bleed", HHClosedDestination + "HHClosed_1_bleed.wav", defaultMidiNotes[14], curveFor5[0], curveFor5[1] - 1, hhRelease, 0.9, "CymbalsBleed");
        addSample("Dry HHClosed 2 Bleed", HHClosedDestination + "HHClosed_2_bleed.wav", defaultMidiNotes[14], curveFor5[1], curveFor5[2] - 1, hhRelease, 0.9, "CymbalsBleed");
        addSample("Dry HHClosed 3 Bleed", HHClosedDestination + "HHClosed_3_bleed.wav", defaultMidiNotes[14], curveFor5[2], curveFor5[3] - 1, hhRelease, 1.0, "CymbalsBleed");
        addSample("Dry HHClosed 4 Bleed", HHClosedDestination + "HHClosed_4_bleed.wav", defaultMidiNotes[14], curveFor5[3], curveFor5[4] - 1, hhRelease, 1.3, "CymbalsBleed");
        addSample("Dry HHClosed 5 Bleed", HHClosedDestination + "HHClosed_5_bleed.wav", defaultMidiNotes[14], curveFor5[4], curveFor5[5] - 1, hhRelease, 1.0, "CymbalsBleed");

        double hhHalfMaxLen = 1.4;
        string HHHalfDestination = HHAllDestination + "HHHalf/";
        addSample("Dry HHHalf 1 Close", HHHalfDestination + "HHHalf_1_close.wav", defaultMidiNotes[15], curveFor4[0], curveFor4[1] - 1, hhRelease, hhHalfMaxLen, "HHClose");
        addSample("Dry HHHalf 2 Close", HHHalfDestination + "HHHalf_2_close.wav", defaultMidiNotes[15], curveFor4[1], curveFor4[2] - 1, hhRelease, hhHalfMaxLen, "HHClose");
        addSample("Dry HHHalf 3 Close", HHHalfDestination + "HHHalf_3_close.wav", defaultMidiNotes[15], curveFor4[2], curveFor4[3] - 1, hhRelease, hhHalfMaxLen, "HHClose");
        addSample("Dry HHHalf 4 Close", HHHalfDestination + "HHHalf_4_close.wav", defaultMidiNotes[15], curveFor4[3], curveFor4[4] - 1, hhRelease, hhHalfMaxLen, "HHClose");
        addSample("Dry HHHalf 1 OH", HHHalfDestination + "HHHalf_1_OH.wav", defaultMidiNotes[15], curveFor4[0], curveFor4[1] - 1, hhRelease, hhHalfMaxLen, "CymbalsOH");
        addSample("Dry HHHalf 2 OH", HHHalfDestination + "HHHalf_2_OH.wav", defaultMidiNotes[15], curveFor4[1], curveFor4[2] - 1, hhRelease, hhHalfMaxLen, "CymbalsOH");
        addSample("Dry HHHalf 3 OH", HHHalfDestination + "HHHalf_3_OH.wav", defaultMidiNotes[15], curveFor4[2], curveFor4[3] - 1, hhRelease, hhHalfMaxLen, "CymbalsOH");
        addSample("Dry HHHalf 4 OH", HHHalfDestination + "HHHalf_4_OH.wav", defaultMidiNotes[15], curveFor4[3], curveFor4[4] - 1, hhRelease, hhHalfMaxLen, "CymbalsOH");
        addSample("Dry HHHalf 1 Room", HHHalfDestination + "HHHalf_1_room.wav", defaultMidiNotes[15], curveFor4[0], curveFor4[1] - 1, hhRelease, hhHalfMaxLen, "CymbalsRoom");
        addSample("Dry HHHalf 2 Room", HHHalfDestination + "HHHalf_2_room.wav", defaultMidiNotes[15], curveFor4[1], curveFor4[2] - 1, hhRelease, hhHalfMaxLen, "CymbalsRoom");
        addSample("Dry HHHalf 3 Room", HHHalfDestination + "HHHalf_3_room.wav", defaultMidiNotes[15], curveFor4[2], curveFor4[3] - 1, hhRelease, hhHalfMaxLen, "CymbalsRoom");
        addSample("Dry HHHalf 4 Room", HHHalfDestination + "HHHalf_4_room.wav", defaultMidiNotes[15], curveFor4[3], curveFor4[4] - 1, hhRelease, hhHalfMaxLen, "CymbalsRoom");
        addSample("Dry HHHalf 1 Bleed", HHHalfDestination + "HHHalf_1_bleed.wav", defaultMidiNotes[15], curveFor4[0], curveFor4[1] - 1, hhRelease, hhHalfMaxLen, "CymbalsBleed");
        addSample("Dry HHHalf 2 Bleed", HHHalfDestination + "HHHalf_2_bleed.wav", defaultMidiNotes[15], curveFor4[1], curveFor4[2] - 1, hhRelease, hhHalfMaxLen, "CymbalsBleed");
        addSample("Dry HHHalf 3 Bleed", HHHalfDestination + "HHHalf_3_bleed.wav", defaultMidiNotes[15], curveFor4[2], curveFor4[3] - 1, hhRelease, hhHalfMaxLen, "CymbalsBleed");
        addSample("Dry HHHalf 4 Bleed", HHHalfDestination + "HHHalf_4_bleed.wav", defaultMidiNotes[15], curveFor4[3], curveFor4[4] - 1, hhRelease, hhHalfMaxLen, "CymbalsBleed");

        double hhOpenMaxLen = 5.0;
        string HHOpenDestination = HHAllDestination + "HHOpen/";
        addSample("Dry HHOpen 1 Close", HHOpenDestination + "HHOpen_1_close.wav", defaultMidiNotes[16], curveFor4[0], curveFor4[1] - 1, hhRelease, 2.0, "HHClose");
        addSample("Dry HHOpen 2 Close", HHOpenDestination + "HHOpen_2_close.wav", defaultMidiNotes[16], curveFor4[1], curveFor4[2] - 1, hhRelease, 3.2, "HHClose");
        addSample("Dry HHOpen 3 Close", HHOpenDestination + "HHOpen_3_close.wav", defaultMidiNotes[16], curveFor4[2], curveFor4[3] - 1, hhRelease, 3.0, "HHClose");
        addSample("Dry HHOpen 4 Close", HHOpenDestination + "HHOpen_4_close.wav", defaultMidiNotes[16], curveFor4[3], curveFor4[4] - 1, hhRelease, 4.2, "HHClose");
        addSample("Dry HHOpen 1 OH", HHOpenDestination + "HHOpen_1_OH.wav", defaultMidiNotes[16], curveFor4[0], curveFor4[1] - 1, hhRelease, 2.0, "CymbalsOH");
        addSample("Dry HHOpen 2 OH", HHOpenDestination + "HHOpen_2_OH.wav", defaultMidiNotes[16], curveFor4[1], curveFor4[2] - 1, hhRelease, 3.2, "CymbalsOH");
        addSample("Dry HHOpen 3 OH", HHOpenDestination + "HHOpen_3_OH.wav", defaultMidiNotes[16], curveFor4[2], curveFor4[3] - 1, hhRelease, 3.0, "CymbalsOH");
        addSample("Dry HHOpen 4 OH", HHOpenDestination + "HHOpen_4_OH.wav", defaultMidiNotes[16], curveFor4[3], curveFor4[4] - 1, hhRelease, 4.2, "CymbalsOH");
        addSample("Dry HHOpen 1 Room", HHOpenDestination + "HHOpen_1_room.wav", defaultMidiNotes[16], curveFor4[0], curveFor4[1] - 1, hhRelease, 2.0, "CymbalsRoom");
        addSample("Dry HHOpen 2 Room", HHOpenDestination + "HHOpen_2_room.wav", defaultMidiNotes[16], curveFor4[1], curveFor4[2] - 1, hhRelease, 3.2, "CymbalsRoom");
        addSample("Dry HHOpen 3 Room", HHOpenDestination + "HHOpen_3_room.wav", defaultMidiNotes[16], curveFor4[2], curveFor4[3] - 1, hhRelease, 3.0, "CymbalsRoom");
        addSample("Dry HHOpen 4 Room", HHOpenDestination + "HHOpen_4_room.wav", defaultMidiNotes[16], curveFor4[3], curveFor4[4] - 1, hhRelease, 4.2, "CymbalsRoom");
        addSample("Dry HHOpen 1 Bleed", HHOpenDestination + "HHOpen_1_bleed.wav", defaultMidiNotes[16], curveFor4[0], curveFor4[1] - 1, hhRelease, 2.0, "CymbalsBleed");
        addSample("Dry HHOpen 2 Bleed", HHOpenDestination + "HHOpen_2_bleed.wav", defaultMidiNotes[16], curveFor4[1], curveFor4[2] - 1, hhRelease, 3.2, "CymbalsBleed");
        addSample("Dry HHOpen 3 Bleed", HHOpenDestination + "HHOpen_3_bleed.wav", defaultMidiNotes[16], curveFor4[2], curveFor4[3] - 1, hhRelease, 3.0, "CymbalsBleed");
        addSample("Dry HHOpen 4 Bleed", HHOpenDestination + "HHOpen_4_bleed.wav", defaultMidiNotes[16], curveFor4[3], curveFor4[4] - 1, hhRelease, 4.2, "CymbalsBleed");

        string tambDestination = dryDestination + "tambourine/";
        addSample("Dry Tambourine 1 OH", tambDestination + "tambourine_1_OH.wav", defaultMidiNotes[17], curveFor3[0], curveFor3[1] - 1, hhRelease, 0.5, "CymbalsOH");
        addSample("Dry Tambourine 2 OH", tambDestination + "tambourine_2_OH.wav", defaultMidiNotes[17], curveFor3[1], curveFor3[2] - 1, hhRelease, 0.9, "CymbalsOH");
        addSample("Dry Tambourine 3 OH", tambDestination + "tambourine_3_OH.wav", defaultMidiNotes[17], curveFor3[2], curveFor3[3] - 1, hhRelease, 0.8, "CymbalsOH");
        addSample("Dry Tambourine 1 Room", tambDestination + "tambourine_1_room.wav", defaultMidiNotes[17], curveFor3[0], curveFor3[1] - 1, hhRelease, 0.5, "CymbalsRoom");
        addSample("Dry Tambourine 2 Room", tambDestination + "tambourine_2_room.wav", defaultMidiNotes[17], curveFor3[1], curveFor3[2] - 1, hhRelease, 0.9, "CymbalsRoom");
        addSample("Dry Tambourine 3 Room", tambDestination + "tambourine_3_room.wav", defaultMidiNotes[17], curveFor3[2], curveFor3[3] - 1, hhRelease, 0.8, "CymbalsRoom");
        addSample("Dry Tambourine 1 Bleed", tambDestination + "tambourine_1_bleed.wav", defaultMidiNotes[17], curveFor3[0], curveFor3[1] - 1, hhRelease, 0.5, "CymbalsBleed");
        addSample("Dry Tambourine 2 Bleed", tambDestination + "tambourine_2_bleed.wav", defaultMidiNotes[17], curveFor3[1], curveFor3[2] - 1, hhRelease, 0.9, "CymbalsBleed");
        addSample("Dry Tambourine 3 Bleed", tambDestination + "tambourine_3_bleed.wav", defaultMidiNotes[17], curveFor3[2], curveFor3[3] - 1, hhRelease, 0.8, "CymbalsBleed");
        ...
        addSample("Dry RidePoint 1 OH", RidePointDestination + "ridePoint_1_OH.wav", defaultMidiNotes[18], curveFor4[0], curveFor4[1] - 1, RideRelease, 3.5, "CymbalsOH");
        addSample("Dry RidePoint 2 OH", RidePointDestination + "ridePoint_2_OH.wav", defaultMidiNotes[18], curveFor4[1], curveFor4[2] - 1, RideRelease, 3.7, "CymbalsOH");
        addSample("Dry RidePoint 3 OH", RidePointDestination + "ridePoint_3_OH.wav", defaultMidiNotes[18], curveFor4[2], curveFor4[3] - 1, RideRelease, 4.5, "CymbalsOH");
        addSample("Dry RidePoint 4 OH", RidePointDestination + "ridePoint_4_OH.wav", defaultMidiNotes[18], curveFor4[3], curveFor4[4] - 1, RideRelease, 5.3, "CymbalsOH");
        addSample("Dry RidePoint 1 Room", RidePointDestination + "ridePoint_1_room.wav", defaultMidiNotes[18], curveFor4[0], curveFor4[1] - 1, RideRelease, 3.5, "CymbalsRoom");
        addSample("Dry RidePoint 2 Room", RidePointDestination + "ridePoint_2_room.wav", defaultMidiNotes[18], curveFor4[1], curveFor4[2] - 1, RideRelease, 3.7, "CymbalsRoom");
        addSample("Dry RidePoint 3 Room", RidePointDestination + "ridePoint_3_room.wav", defaultMidiNotes[18], curveFor4[2], curveFor4[3] - 1, RideRelease, 4.5, "CymbalsRoom");
        addSample("Dry RidePoint 4 Room", RidePointDestination + "ridePoint_4_room.wav", defaultMidiNotes[18], curveFor4[3], curveFor4[4] - 1, RideRelease, 5.3, "CymbalsRoom");
        addSample("Dry RidePoint 1 Bleed", RidePointDestination + "ridePoint_1_bleed.wav", defaultMidiNotes[18], curveFor4[0], curveFor4[1] - 1, RideRelease, 3.5, "CymbalsBleed");
        addSample("Dry RidePoint 2 Bleed", RidePointDestination + "ridePoint_2_bleed.wav", defaultMidiNotes[18], curveFor4[1], curveFor4[2] - 1, RideRelease, 3.7, "CymbalsBleed");
        addSample("Dry RidePoint 3 Bleed", RidePointDestination + "ridePoint_3_bleed.wav", defaultMidiNotes[18], curveFor4[2], curveFor4[3] - 1, RideRelease, 4.5, "CymbalsBleed");
        addSample("Dry RidePoint 4 Bleed", RidePointDestination + "ridePoint_4_bleed.wav", defaultMidiNotes[18], curveFor4[3], curveFor4[4] - 1, RideRelease, 5.3, "CymbalsBleed");

        string RideBellDestination = RideAllDestination + "rideBell/";
        addSample("Dry RideBell 1 OH", RideBellDestination + "rideBell_1_OH.wav", defaultMidiNotes[19], curveFor4[0], curveFor4[1] - 1, RideRelease, 2.95, "CymbalsOH");
        addSample("Dry RideBell 2 OH", RideBellDestination + "rideBell_2_OH.wav", defaultMidiNotes[19], curveFor4[1], curveFor4[2] - 1, RideRelease, 3.32, "CymbalsOH");
        addSample("Dry RideBell 3 OH", RideBellDestination + "rideBell_3_OH.wav", defaultMidiNotes[19], curveFor4[2], curveFor4[3] - 1, RideRelease, 3.70, "CymbalsOH");
        addSample("Dry RideBell 4 OH", RideBellDestination + "rideBell_4_OH.wav", defaultMidiNotes[19], curveFor4[3], curveFor4[4] - 1, RideRelease, 4.30, "CymbalsOH");
        addSample("Dry RideBell 1 Room", RideBellDestination + "rideBell_1_room.wav", defaultMidiNotes[19], curveFor4[0], curveFor4[1] - 1, RideRelease, 2.95, "CymbalsRoom");
        addSample("Dry RideBell 2 Room", RideBellDestination + "rideBell_2_room.wav", defaultMidiNotes[19], curveFor4[1], curveFor4[2] - 1, RideRelease, 3.32, "CymbalsRoom");
        addSample("Dry RideBell 3 Room", RideBellDestination + "rideBell_3_room.wav", defaultMidiNotes[19], curveFor4[2], curveFor4[3] - 1, RideRelease, 3.70, "CymbalsRoom");
        addSample("Dry RideBell 4 Room", RideBellDestination + "rideBell_4_room.wav", defaultMidiNotes[19], curveFor4[3], curveFor4[4] - 1, RideRelease, 4.30, "CymbalsRoom");
        addSample("Dry RideBell 1 Bleed", RideBellDestination + "rideBell_1_bleed.wav", defaultMidiNotes[19], curveFor4[0], curveFor4[1] - 1, RideRelease, 2.95, "CymbalsBleed");
        addSample("Dry RideBell 2 Bleed", RideBellDestination + "rideBell_2_bleed.wav", defaultMidiNotes[19], curveFor4[1], curveFor4[2] - 1, RideRelease, 3.32, "CymbalsBleed");
        addSample("Dry RideBell 3 Bleed", RideBellDestination + "rideBell_3_bleed.wav", defaultMidiNotes[19], curveFor4[2], curveFor4[3] - 1, RideRelease, 3.70, "CymbalsBleed");
        addSample("Dry RideBell 4 Bleed", RideBellDestination + "rideBell_4_bleed.wav", defaultMidiNotes[19], curveFor4[3], curveFor4[4] - 1, RideRelease, 4.30, "CymbalsBleed");

        double RideOpenRelease = 4.5;
        string RideOpenDestination = RideAllDestination + "rideOpen/";
        addSample("Dry RideOpen 1 OH", RideOpenDestination + "rideOpen_1_OH.wav", defaultMidiNotes[20], curveFor4[0], curveFor4[1] - 1, RideOpenRelease, 5.80, "CymbalsOH");
        addSample("Dry RideOpen 2 OH", RideOpenDestination + "rideOpen_2_OH.wav", defaultMidiNotes[20], curveFor4[1], curveFor4[2] - 1, RideOpenRelease, 5.30, "CymbalsOH");
        addSample("Dry RideOpen 3 OH", RideOpenDestination + "rideOpen_3_OH.wav", defaultMidiNotes[20], curveFor4[2], curveFor4[3] - 1, RideOpenRelease, 5.85, "CymbalsOH");
        addSample("Dry RideOpen 4 OH", RideOpenDestination + "rideOpen_4_OH.wav", defaultMidiNotes[20], curveFor4[3], curveFor4[4] - 1, RideOpenRelease, 7.80, "CymbalsOH");
        addSample("Dry RideOpen 1 Room", RideOpenDestination + "rideOpen_1_room.wav", defaultMidiNotes[20], curveFor4[0], curveFor4[1] - 1, RideOpenRelease, 5.80, "CymbalsRoom");
        addSample("Dry RideOpen 2 Room", RideOpenDestination + "rideOpen_2_room.wav", defaultMidiNotes[20], curveFor4[1], curveFor4[2] - 1, RideOpenRelease, 5.30, "CymbalsRoom");
        addSample("Dry RideOpen 3 Room", RideOpenDestination + "rideOpen_3_room.wav", defaultMidiNotes[20], curveFor4[2], curveFor4[3] - 1, RideOpenRelease, 5.85, "CymbalsRoom");
        addSample("Dry RideOpen 4 Room", RideOpenDestination + "rideOpen_4_room.wav", defaultMidiNotes[20], curveFor4[3], curveFor4[4] - 1, RideOpenRelease, 7.80, "CymbalsRoom");
        addSample("Dry RideOpen 1 Bleed", RideOpenDestination + "rideOpen_1_bleed.wav", defaultMidiNotes[20], curveFor4[0], curveFor4[1] - 1, RideOpenRelease, 5.80, "CymbalsBleed");
        addSample("Dry RideOpen 2 Bleed", RideOpenDestination + "rideOpen_2_bleed.wav", defaultMidiNotes[20], curveFor4[1], curveFor4[2] - 1, RideOpenRelease, 5.30, "CymbalsBleed");
        addSample("Dry RideOpen 3 Bleed", RideOpenDestination + "rideOpen_3_bleed.wav", defaultMidiNotes[20], curveFor4[2], curveFor4[3] - 1, RideOpenRelease, 5.85, "CymbalsBleed");
        addSample("Dry RideOpen 4 Bleed", RideOpenDestination + "rideOpen_4_bleed.wav", defaultMidiNotes[20], curveFor4[3], curveFor4[4] - 1, RideOpenRelease, 7.80, "CymbalsBleed");
        ...
        addSample("Dry CrashPoint 1 OH", CrashPointDestination + "crashPoint_1_OH.wav", defaultMidiNotes[21], curveFor3[0], curveFor3[1] - 1, CrashRelease, 2.08, "CymbalsOH");
        addSample("Dry CrashPoint 2 OH", CrashPointDestination + "crashPoint_2_OH.wav", defaultMidiNotes[21], curveFor3[1], curveFor3[2] - 1, CrashRelease, 1.96, "CymbalsOH");
        addSample("Dry CrashPoint 3 OH", CrashPointDestination + "crashPoint_3_OH.wav", defaultMidiNotes[21], curveFor3[2], curveFor3[3] - 1, CrashRelease, 3.20, "CymbalsOH");
        addSample("Dry CrashPoint 1 Room", CrashPointDestination + "crashPoint_1_room.wav", defaultMidiNotes[21], curveFor3[0], curveFor3[1] - 1, CrashRelease, 2.08, "CymbalsRoom");
        addSample("Dry CrashPoint 2 Room", CrashPointDestination + "crashPoint_2_room.wav", defaultMidiNotes[21], curveFor3[1], curveFor3[2] - 1, CrashRelease, 1.96, "CymbalsRoom");
        addSample("Dry CrashPoint 3 Room", CrashPointDestination + "crashPoint_3_room.wav", defaultMidiNotes[21], curveFor3[2], curveFor3[3] - 1, CrashRelease, 3.20, "CymbalsRoom");
        addSample("Dry CrashPoint 1 Bleed", CrashPointDestination + "crashPoint_1_bleed.wav", defaultMidiNotes[21], curveFor3[0], curveFor3[1] - 1, CrashRelease, 2.08, "CymbalsBleed");
        addSample("Dry CrashPoint 2 Bleed", CrashPointDestination + "crashPoint_2_bleed.wav", defaultMidiNotes[21], curveFor3[1], curveFor3[2] - 1, CrashRelease, 1.96, "CymbalsBleed");
        addSample("Dry CrashPoint 3 Bleed", CrashPointDestination + "crashPoint_3_bleed.wav", defaultMidiNotes[21], curveFor3[2], curveFor3[3] - 1, CrashRelease, 3.20, "CymbalsBleed");

        string CrashBellDestination = CrashAllDestination + "crashBell/";
        addSample("Dry CrashBell 1 OH", CrashBellDestination + "crashBell_1_OH.wav", defaultMidiNotes[22], curveFor3[0], curveFor3[1] - 1, CrashRelease, 1.22, "CymbalsOH");
        addSample("Dry CrashBell 2 OH", CrashBellDestination + "crashBell_2_OH.wav", defaultMidiNotes[22], curveFor3[1], curveFor3[2] - 1, CrashRelease, 1.84, "CymbalsOH");
        addSample("Dry CrashBell 3 OH", CrashBellDestination + "crashBell_3_OH.wav", defaultMidiNotes[22], curveFor3[2], curveFor3[3] - 1, CrashRelease, 2.81, "CymbalsOH");
        addSample("Dry CrashBell 1 Room", CrashBellDestination + "crashBell_1_room.wav", defaultMidiNotes[22], curveFor3[0], curveFor3[1] - 1, CrashRelease, 1.22, "CymbalsRoom");
        addSample("Dry CrashBell 2 Room", CrashBellDestination + "crashBell_2_room.wav", defaultMidiNotes[22], curveFor3[1], curveFor3[2] - 1, CrashRelease, 1.84, "CymbalsRoom");
        addSample("Dry CrashBell 3 Room", CrashBellDestination + "crashBell_3_room.wav", defaultMidiNotes[22], curveFor3[2], curveFor3[3] - 1, CrashRelease, 2.81, "CymbalsRoom");
        addSample("Dry CrashBell 1 Bleed", CrashBellDestination + "crashBell_1_bleed.wav", defaultMidiNotes[22], curveFor3[0], curveFor3[1] - 1, CrashRelease, 1.22, "CymbalsBleed");
        addSample("Dry CrashBell 2 Bleed", CrashBellDestination + "crashBell_2_bleed.wav", defaultMidiNotes[22], curveFor3[1], curveFor3[2] - 1, CrashRelease, 1.84, "CymbalsBleed");
        addSample("Dry CrashBell 3 Bleed", CrashBellDestination + "crashBell_3_bleed.wav", defaultMidiNotes[22], curveFor3[2], curveFor3[3] - 1, CrashRelease, 2.81, "CymbalsBleed");

        double CrashOpenRelease = 0.14;
        double CrashOpenMaxLen = 6.0;
        string CrashOpenDestination = CrashAllDestination + "crashOpen/";
        addSample("Dry CrashOpen 1 OH", CrashOpenDestination + "crashOpen_1_OH.wav", defaultMidiNotes[23], curveFor4[0], curveFor4[1] - 1, CrashOpenRelease, 2.45, "CymbalsOH");
        addSample("Dry CrashOpen 2 OH", CrashOpenDestination + "crashOpen_2_OH.wav", defaultMidiNotes[23], curveFor4[1], curveFor4[2] - 1, CrashOpenRelease, 3.30, "CymbalsOH");
        addSample("Dry CrashOpen 3 OH", CrashOpenDestination + "crashOpen_3_OH.wav", defaultMidiNotes[23], curveFor4[2], curveFor4[3] - 1, CrashOpenRelease, 3.80, "CymbalsOH");
        addSample("Dry CrashOpen 4 OH", CrashOpenDestination + "crashOpen_4_OH.wav", defaultMidiNotes[23], curveFor4[3], curveFor4[4] - 1, CrashOpenRelease, 4.90, "CymbalsOH");
        addSample("Dry CrashOpen 1 Room", CrashOpenDestination + "crashOpen_1_room.wav", defaultMidiNotes[23], curveFor4[0], curveFor4[1] - 1, CrashOpenRelease, 2.45, "CymbalsRoom");
        addSample("Dry CrashOpen 2 Room", CrashOpenDestination + "crashOpen_2_room.wav", defaultMidiNotes[23], curveFor4[1], curveFor4[2] - 1, CrashOpenRelease, 3.30, "CymbalsRoom");
        addSample("Dry CrashOpen 3 Room", CrashOpenDestination + "crashOpen_3_room.wav", defaultMidiNotes[23], curveFor4[2], curveFor4[3] - 1, CrashOpenRelease, 3.80, "CymbalsRoom");
        addSample("Dry CrashOpen 4 Room", CrashOpenDestination + "crashOpen_4_room.wav", defaultMidiNotes[23], curveFor4[3], curveFor4[4] - 1, CrashOpenRelease, 4.90, "CymbalsRoom");
        addSample("Dry CrashOpen 1 Bleed", CrashOpenDestination + "crashOpen_1_bleed.wav", defaultMidiNotes[23], curveFor4[0], curveFor4[1] - 1, CrashOpenRelease, 2.45, "CymbalsBleed");
        addSample("Dry CrashOpen 2 Bleed", CrashOpenDestination + "crashOpen_2_bleed.wav", defaultMidiNotes[23], curveFor4[1], curveFor4[2] - 1, CrashOpenRelease, 3.30, "CymbalsBleed");
        addSample("Dry CrashOpen 3 Bleed", CrashOpenDestination + "crashOpen_3_bleed.wav", defaultMidiNotes[23], curveFor4[2], curveFor4[3] - 1, CrashOpenRelease, 3.80, "CymbalsBleed");
        addSample("Dry CrashOpen 4 Bleed", CrashOpenDestination + "crashOpen_4_bleed.wav", defaultMidiNotes[23], curveFor4[3], curveFor4[4] - 1, CrashOpenRelease, 4.90, "CymbalsBleed");
