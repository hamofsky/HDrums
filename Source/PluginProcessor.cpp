...
HDrumsAudioProcessor::HDrumsAudioProcessor()// : samplerVoice(procA)
...
#endif
{
    ...
    loadSamples(1, 1, 60);  // default settings for samples
...
void HDrumsAudioProcessor::addSample(string sampleName, string destination, int midiNote, int lowestVelocity, int highestVelocity, double release, double maxLength, int bus)
{
...
void HDrumsAudioProcessor::loadSamples(int samplePackID, int curveMenuID, int snareNoteID)
{
    ...
    if (samplePackID == 1) {
        ...
        HDrumsAudioProcessor::addSample("Ride Hard", destinationP + "Ride Hard.wav", 65, curve[0], 127, 5.0, 8.0, 0);
        HDrumsAudioProcessor::addSample("Ride Smooth", destinationP + "Ride Smooth.wav", 65, 1, curve[0] - 1, 0.5, 8.0, 0);
        string GGDdestination = destinationP + "GGD/";
        HDrumsAudioProcessor::addSample("HH open", GGDdestination + "HH open.wav", 64, 1, 127, 0.12, 6.5, 0);
        HDrumsAudioProcessor::addSample("HH closed", GGDdestination + "HH closed.wav", 62, 1, 127, 0.1, 2.0, 0);

        string snareDestination = destinationP + "Konrad1/Snare/";
        HDrumsAudioProcessor::addSample("Snare 1_1", snareDestination + "Snare 1_1.wav", snareNoteID, curve[4], 127, snareRelease, snareMaxLen, 0);
        HDrumsAudioProcessor::addSample("Snare 2_1", snareDestination + "Snare 2_1.wav", snareNoteID, curve[3], curve[4] - 1, snareRelease, snareMaxLen, 0);
        HDrumsAudioProcessor::addSample("Snare 3_1", snareDestination + "Snare 3_1.wav", snareNoteID, curve[2], curve[3] - 1, snareRelease, snareMaxLen, 0);
        HDrumsAudioProcessor::addSample("Snare 4_1", snareDestination + "Snare 4_1.wav", snareNoteID, curve[1], curve[2] - 1, snareRelease, snareMaxLen, 0);
        HDrumsAudioProcessor::addSample("Snare 5_1", snareDestination + "Snare 5_1.wav", snareNoteID, curve[0], curve[1] - 1, snareRelease, snareMaxLen, 0);
        HDrumsAudioProcessor::addSample("Snare 6_1", snareDestination + "Snare 6_1.wav", snareNoteID, 1, curve[0] - 1, snareRelease, snareMaxLen, 0);
        string kickDestination = destinationP + "Konrad1/Kick/";
        HDrumsAudioProcessor::addSample("Kick 0_1", kickDestination + "Kick 0_1.wav", 57, 126, 127, 0.6, 2.0, 0);
        HDrumsAudioProcessor::addSample("Kick 1_1", kickDestination + "Kick 1_1.wav", 57, 114, 125, 0.6, 2.0, 0);
        HDrumsAudioProcessor::addSample("Kick 2_1", kickDestination + "Kick 2_1.wav", 57, 100, 113, 0.6, 2.0, 0);
        HDrumsAudioProcessor::addSample("Kick 3_1", kickDestination + "Kick 3_1.wav", 57, 85, 99, 0.6, 2.0, 0);
        HDrumsAudioProcessor::addSample("Kick 4_1", kickDestination + "Kick 4_1.wav", 57, 75, 84, 0.6, 2.0, 0);
        HDrumsAudioProcessor::addSample("Kick 5_1", kickDestination + "Kick 5_1.wav", 57, 66, 74, 0.6, 2.0, 0);
        HDrumsAudioProcessor::addSample("Kick 6_1", kickDestination + "Kick 6_1.wav", 57, curve[0], curve[1] - 1, 0.6, 2.0, 0);
        HDrumsAudioProcessor::addSample("Kick 7_1", kickDestination + "Kick 7_1.wav", 57, 1, curve[0] - 1, 0.6, 2.0, 0);
        string FTCloseDestination = destinationP + "Konrad1/FT/Close/";
        HDrumsAudioProcessor::addSample("FT Close 1_1", FTCloseDestination + "FT Close 1_1.wav", 67, 1, 127, 0.7, 1.5, 0);
        string FTOHDestination = destinationP + "Konrad1/FT/OH/";
        HDrumsAudioProcessor::addSample("FT OH 1_1", FTOHDestination + "FT OH 1_1.wav", 69, 1, 127, 0.7, 1.5, 1);
    }
        ...
        // sampleName, File destination, midiNote, lowestVelocity, highestVelocity, release in s, maxLength in s, bus select (0 - Close Mics, 1 - OH, 2 - Room)
        HDrumsAudioProcessor::addSample("Leaf Kick + Crash", LeafDestination + "Leaf Kick + Crash.wav", 65, 1, 127, 5.0, 8.0, 0);
        HDrumsAudioProcessor::addSample("Leaf Kick", LeafDestination + "Leaf Kick.wav", 57, 1, 127, 0.6, 2.0, 0);
        HDrumsAudioProcessor::addSample("Leaf Snare", LeafDestination + "Leaf Snare.wav", snareNoteID, 1, 127, 0.5, 2.0, 0);
        HDrumsAudioProcessor::addSample("Leaf Trap Hat", LeafDestination + "Leaf Trap Hat.wav", 64, 1, 127, 0.12, 6.5, 0);
        HDrumsAudioProcessor::addSample("Leaf Hat", LeafDestination + "Leaf Hat.wav", 62, 1, 127, 0.1, 2.0, 0);
    }
}
